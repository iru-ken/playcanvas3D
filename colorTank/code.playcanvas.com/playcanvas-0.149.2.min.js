/*
 PlayCanvas Engine v0.149.2 revision 0fc0b2844def
 http://playcanvas.com
...
b,c){var a=a.data,b=b.data,e=this.data;e[0]=a[0]+c*(b[0]-a[0]);e[1]=a[1]+c*(b[1]-a[1]);e[2]=a[2]+c*(b[2]-a[2]);return this},mul:function(a){var b=this.data,a=a.data;b[0]*=a[0];b[1]*=a[1];b[2]*=a[2];return this},mul2:function(a,b){var c=a.data,e=b.data,f=this.data;f[0]=c[0]*e[0];f[1]=c[1]*e[1];f[2]=c[2]*e[2];return this},normalize:function(){return this.scale(1/this.length())},scale:function(a){var b=this.data;b[0]*=a;b[1]*=a;b[2]*=a;return this},set:function(a,b,c){var e=this.data;e[0]=a;e[1]=b;e[2]=
...
this._device.gl;a.bindFramebuffer(a.FRAMEBUFFER,null)}};Object.defineProperty(a.prototype,"colorBuffer",{get:function(){return this._colorBuffer}});Object.defineProperty(a.prototype,"face",{get:function(){return this._face}});Object.defineProperty(a.prototype,"width",{get:function(){return this._colorBuffer.width}});Object.defineProperty(a.prototype,"height",{get:function(){return this._colorBuffer.height}});return{RenderTarget:a}}());pc.gfx.ShaderInputType={BOOL:0,INT:1,FLOAT:2,VEC2:3,VEC3:4,VEC4:5,IVEC2:6,IVEC3:7,IVEC4:8,BVEC2:9,BVEC3:10,BVEC4:11,MAT2:12,MAT3:13,MAT4:14,TEXTURE2D:15,TEXTURECUBE:16};pc.gfx.ShaderInput=function(d,a,b,c){this.locationId=c;this.scopeId=d.scope.resolve(a);this.version=new pc.gfx.Version;this.dataType=b};pc.extend(pc.gfx,function(){function d(a,c,e){var f=a.createShader(c);a.shaderSource(f,e);a.compileShader(f);if(!a.getShaderParameter(f,a.COMPILE_STATUS)){for(var d=a.getShaderInfoLog(f),k=logERROR,a="Failed to compile "+(c===a.VERTEX_SHADER?"vertex":"fragment")+" shader:\n\n",e=e.split("\n"),c=0,l=e.length;c<l;c++)e[c]=c+1+":\t"+e[c];e=e.join("\n");k(a+e+"\n\n"+d)}return f}var a=function(a,c){this.device=a;this.definition=c;var e=this.device.gl,f=d(e,e.VERTEX_SHADER,c.vshader),g=d(e,e.FRAGMENT_SHADER,
c.fshader),k=e.createProgram();e.attachShader(k,f);e.attachShader(k,g);e.linkProgram(k);if(!e.getProgramParameter(k,e.LINK_STATUS)){var l=e.getProgramInfoLog(k);logERROR("Failed to link shader program. Error: "+l)}this.program=k;e.deleteShader(f);e.deleteShader(g);this.attributes=[];this.uniforms=[];this.samplers=[];f=0;g={};g[e.BOOL]=pc.gfx.ShaderInputType.BOOL;g[e.INT]=pc.gfx.ShaderInputType.INT;g[e.FLOAT]=pc.gfx.ShaderInputType.FLOAT;g[e.FLOAT_VEC2]=pc.gfx.ShaderInputType.VEC2;g[e.FLOAT_VEC3]=
pc.gfx.ShaderInputType.VEC3;g[e.FLOAT_VEC4]=pc.gfx.ShaderInputType.VEC4;g[e.INT_VEC2]=pc.gfx.ShaderInputType.IVEC2;g[e.INT_VEC3]=pc.gfx.ShaderInputType.IVEC3;g[e.INT_VEC4]=pc.gfx.ShaderInputType.IVEC4;g[e.BOOL_VEC2]=pc.gfx.ShaderInputType.BVEC2;g[e.BOOL_VEC3]=pc.gfx.ShaderInputType.BVEC3;g[e.BOOL_VEC4]=pc.gfx.ShaderInputType.BVEC4;g[e.FLOAT_MAT2]=pc.gfx.ShaderInputType.MAT2;g[e.FLOAT_MAT3]=pc.gfx.ShaderInputType.MAT3;g[e.FLOAT_MAT4]=pc.gfx.ShaderInputType.MAT4;g[e.SAMPLER_2D]=pc.gfx.ShaderInputType.TEXTURE2D;
g[e.SAMPLER_CUBE]=pc.gfx.ShaderInputType.TEXTURECUBE;for(var n=e.getProgramParameter(this.program,e.ACTIVE_ATTRIBUTES);f<n;)k=e.getActiveAttrib(this.program,f++),l=e.getAttribLocation(this.program,k.name),"undefined"===typeof c.attributes[k.name]&&console.error('Vertex shader attribute "'+k.name+'" is not mapped to a semantic in shader definition.'),k=new pc.gfx.ShaderInput(a,c.attributes[k.name],g[k.type],l),this.attributes.push(k);f=0;for(n=e.getProgramParameter(this.program,e.ACTIVE_UNIFORMS);f<
n;)k=e.getActiveUniform(this.program,f++),l=e.getUniformLocation(this.program,k.name),k.type===e.SAMPLER_2D||k.type===e.SAMPLER_CUBE?this.samplers.push(new pc.gfx.ShaderInput(a,k.name,g[k.type],l)):this.uniforms.push(new pc.gfx.ShaderInput(a,k.name,g[k.type],l))};a.prototype={destroy:function(){this.device.gl.deleteProgram(this.program)}};return{Shader:a}}());pc.extend(pc.gfx,function(){var d=function(a){this._device=a;this._cache={};this._generators={}};d.prototype.register=function(a,b){this.isRegistered(a)||(this._generators[a]=b)};d.prototype.unregister=function(a){this.isRegistered(a)&&delete this._generators[a]};d.prototype.isRegistered=function(a){return void 0!==this._generators[a]};d.prototype.getProgram=function(a,b){var c=this._generators[a];if(void 0===c)return logERROR("No program library functions registered for: "+a),null;var e=c.generateKey(f,
b),f=this._cache[e];if(!f){var f=this._device,c=c.createShaderDefinition(f,b);logDEBUG("\n"+e+": vertex shader\n"+c.vshader);logDEBUG("\n"+e+": fragment shader\n"+c.fshader);f=this._cache[e]=new pc.gfx.Shader(f,c)}return f};return{ProgramLibrary:d}}());pc.gfx.precalculatedTangents=!0;
...
this.defaultClearOptions={color:[0,0,0,1],depth:1,flags:pc.gfx.CLEARFLAG_COLOR|pc.gfx.CLEARFLAG_DEPTH};this.glPrimitive=[m.POINTS,m.LINES,m.LINE_STRIP,m.TRIANGLES,m.TRIANGLE_STRIP];this.glBlendEquation=[m.FUNC_ADD,m.FUNC_SUBTRACT,m.FUNC_REVERSE_SUBTRACT];this.glBlendFunction=[m.ZERO,m.ONE,m.SRC_COLOR,m.ONE_MINUS_SRC_COLOR,m.DST_COLOR,m.ONE_MINUS_DST_COLOR,m.SRC_ALPHA,m.SRC_ALPHA_SATURATE,m.ONE_MINUS_SRC_ALPHA,m.DST_ALPHA,m.ONE_MINUS_DST_ALPHA];this.glClearFlag=[0,m.COLOR_BUFFER_BIT,m.DEPTH_BUFFER_BIT,
...
if(l||a.lightMap)h+="    gl_FragColor.rgb += diffuse;\n";l&&(h+="    gl_FragColor.rgb += specular;\n");h+="    gl_FragColor.rgb += emissive;\n";h+="    gl_FragColor.a    = opacity;\n\n";h+=s(d,"fs_alpha_test");h+=s(d,"fs_clamp");switch(a.fog){case "linear":h+=s(d,"fs_fog_linear");break;case "exp":h+=s(d,"fs_fog_exp");break;case "exp2":h+=s(d,"fs_fog_exp2")}h+=s(d,"common_main_end");return{attributes:m,vshader:v,fshader:h}}};pc.gfx.programlib.pick={generateKey:function(d,a){var b="pick";a.skin&&(b+="_skin");return b},createShaderDefinition:function(d,a){var b={vertex_position:pc.gfx.SEMANTIC_POSITION};a.skin&&(b.vertex_boneWeights=pc.gfx.SEMANTIC_BLENDWEIGHT,b.vertex_boneIndices=pc.gfx.SEMANTIC_BLENDINDICES);var c=pc.gfx.programlib.getSnippet,e="",e=a.skin?e+c(d,"vs_skin_position_decl"):e+c(d,"vs_static_position_decl"),e=e+c(d,"common_main_begin"),e=a.skin?e+c(d,"vs_skin_position"):e+c(d,"vs_static_position"),f=e+=c(d,
"common_main_end"),e=c(d,"fs_precision"),e=e+c(d,"fs_flat_color_decl"),e=e+c(d,"common_main_begin"),e=e+c(d,"fs_flat_color"),e=e+c(d,"common_main_end");return{attributes:b,vshader:f,fshader:e}}};pc.gfx.programlib.skybox={generateKey:function(){return"skybox"},createShaderDefinition:function(d){var a=pc.gfx.programlib.getSnippet;return{attributes:{aPosition:pc.gfx.SEMANTIC_POSITION},vshader:"attribute vec3 aPosition;\n\nuniform mat4 matrix_view;\nuniform mat4 matrix_projection;\n\nvarying vec3 vViewDir;\n\nvoid main(void)\n{\n    mat4 view = matrix_view;\n    view[3][0] = view[3][1] = view[3][2] = 0.0;\n    gl_Position = matrix_projection * view * vec4(aPosition, 1.0);\n    gl_Position.z = gl_Position.w - 0.00001;\n    vViewDir = aPosition;\n}",
...
b.element[pc.gfx.SEMANTIC_POSITION].set(1,-1);b.next();b.element[pc.gfx.SEMANTIC_POSITION].set(-1,1);b.next();b.element[pc.gfx.SEMANTIC_POSITION].set(1,1);b.end();return a},drawFullscreenQuad:function(a,b,c,e,d){a.setRenderTarget(b);a.updateBegin();var g=null!==b?b.width:a.width,b=null!==b?b.height:a.height,k=0,l=0;d&&(k=d.x*g,l=d.y*b,g*=d.z,b*=d.w);a.setViewport(k,l,g,b);a.setScissor(k,l,g,b);d=a.getDepthTest();g=a.getDepthWrite();a.setDepthTest(!1);a.setDepthWrite(!1);a.setVertexBuffer(c,0);a.setShader(e);
a.draw({type:pc.gfx.PRIMITIVE_TRISTRIP,base:0,count:4,indexed:!1});a.setDepthTest(d);a.setDepthWrite(g);a.updateEnd()}}}());pc.extend(pc.posteffect,function(){function d(a,b){this.context=a;this.camera=b;this.effects=[];this.enabled=!1;this.resizeTimeout=this.depthTarget=null;b.on("set_rect",this.onCameraRectChanged,this);this.previous}d.prototype={_createOffscreenTarget:function(a){var b=this.camera.rect,b=new pc.gfx.Texture(this.context.graphicsDevice,{format:pc.gfx.PIXELFORMAT_R8_G8_B8_A8,width:Math.floor(b.z*this.context.graphicsDevice.width),height:Math.floor(b.w*this.context.graphicsDevice.height)});b.minFilter=
pc.gfx.FILTER_NEAREST;b.magFilter=pc.gfx.FILTER_NEAREST;b.addressU=pc.gfx.ADDRESS_CLAMP_TO_EDGE;b.addressV=pc.gfx.ADDRESS_CLAMP_TO_EDGE;return new pc.gfx.RenderTarget(this.context.graphicsDevice,b,{depth:a})},_setDepthTarget:function(a){this.depthTarget!==a&&(this.depthTarget&&this.depthTarget.destroy(),this.depthTarget=a);this.camera.camera._depthTarget=a},addEffect:function(a){var b=0===this.effects.length,c=this.effects,e={effect:a,inputTarget:this._createOffscreenTarget(b),outputTarget:null};
a.needsDepthBuffer&&(this.depthTarget||this._setDepthTarget(this._createOffscreenTarget(!0)),a.depthMap=this.depthTarget.colorBuffer);b&&(this.camera.renderTarget=e.inputTarget);c.push(e);a=c.length;1<a&&(c[a-2].outputTarget=e.inputTarget);this.enable()},removeEffect:function(a){for(var b=-1,c=0,e=this.effects.length;c<e;c++)if(this.effects[c].effect===a){b=c;break}0<=b&&(0<b?this.effects[b-1].outputTarget=b+1<this.effects.length?this.effects[b+1].inputTarget:null:1<this.effects.length&&(this.effects[1].inputTarget._depth||
(this.effects[1].inputTarget.destroy(),this.effects[1].inputTarget=this._createOffscreenTarget(!0)),this.camera.renderTarget=this.effects[1].inputTarget),this.effects[b].inputTarget.destroy(),this.effects.splice(b,1));if(this.depthTarget){a=!1;c=0;for(e=this.effects.length;c<e;c++)if(this.effects[c].effect.needsDepthBuffer){a=!0;break}a||this._setDepthTarget(null)}0===this.effects.length&&this.disable()},destroy:function(){this.depthTarget&&(this.depthTarget.destroy(),this.depthTarget=null);for(var a=
0,b=this.effects.length;a<b;a++)this.effects[a].inputTarget.destroy();this.effects.length=0;this.disable()},enable:function(){if(!this.enabled&&this.effects.length){this.enabled=!0;var a=this.effects,b=this.camera;this.context.graphicsDevice.on("resizecanvas",this._onCanvasResized,this);b.camera.setRect(0,0,1,1);this.command=new pc.scene.Command(pc.scene.LAYER_FX,pc.scene.BLEND_NONE,function(){if(this.enabled&&b.data.isRendering){var c=null,e=a.length;if(e){b.renderTarget=a[0].inputTarget;this._setDepthTarget(this.depthTarget);
for(var d=0;d<e;d++){var g=a[d];d===e-1&&(c=b.rect);g.effect.render(g.inputTarget,g.outputTarget,c)}}}}.bind(this));this.context.scene.drawCalls.push(this.command)}},disable:function(){if(this.enabled){this.enabled=!1;this.context.graphicsDevice.off("resizecanvas",this._onCanvasResized,this);this.camera.renderTarget=null;this.camera.camera._depthTarget=null;var a=this.camera.rect;this.camera.camera.setRect(a.x,a.y,a.z,a.w);a=this.context.scene.drawCalls.indexOf(this.command);0<=a&&this.context.scene.drawCalls.splice(a,
1)}},_onCanvasResized:function(){this.resizeTimeout&&clearTimeout(this.resizeTimeout);this.resizeTimeout=setTimeout(this.resizeRenderTargets.bind(this),500)},resizeRenderTargets:function(){var a=this.camera.rect,b=Math.floor(a.z*this.context.graphicsDevice.width),a=Math.floor(a.w*this.context.graphicsDevice.height),c=this.effects;this.depthTarget&&(this.depthTarget.width!==b&&this.depthTarget.height!==a)&&this._setDepthTarget(this._createOffscreenTarget(!0));for(var e=0,d=c.length;e<d;e++){var g=
c[e];if(g.inputTarget.width!==b||g.inputTarget.height!==a)g.inputTarget.destroy(),g.inputTarget=this._createOffscreenTarget(g.effect.needsDepthBuffer||0===e),g.effect.needsDepthBuffer&&(g.depthMap=this.depthTarget),0<e?c[e-1].outputTarget=g.inputTarget:this.camera.renderTarget=g.inputTarget}},onCameraRectChanged:function(){this.enabled&&(this.camera.camera.setRect(0,0,1,1),this.resizeRenderTargets())}};return{PostEffectQueue:d}}());pc.scene={BLEND_SUBTRACTIVE:0,BLEND_ADDITIVE:1,BLEND_NORMAL:2,BLEND_NONE:3,RENDERSTYLE_SOLID:0,RENDERSTYLE_WIREFRAME:1,RENDERSTYLE_POINTS:2,LAYER_HUD:0,LAYER_GIZMO:1,LAYER_FX:2,LAYER_WORLD:3,FOG_NONE:"none",FOG_LINEAR:"linear",FOG_EXP:"exp",FOG_EXP2:"exp2"};
pc.extend(pc.scene,function(){var d=function(){this.drawCalls=[];this.shadowCasters=[];this.fog=pc.scene.FOG_NONE;this.fogColor=new pc.Color(0,0,0);this.fogStart=1;this.fogEnd=1E3;this.fogDensity=0;this.ambientLight=new pc.Color(0,0,0);this.shadowDistance=40;this._models=[];this._lights=[];this._globalLights=[];this._localLights=[[],[]];this.updateShaders=!0};Object.defineProperty(d.prototype,"fog",{get:function(){return this._fog},set:function(a){a!==this._fog&&(this._fog=a,this.updateShaders=!0)}});
d.prototype._updateShaders=function(a){var b,c=[],e=this.drawCalls;for(b=0;b<e.length;b++){var d=e[b];void 0!==d.material&&-1===c.indexOf(d.material)&&c.push(d.material)}for(b=0;b<c.length;b++)c[b].updateShader(a,this)};d.prototype.getModels=function(){return this._models};d.prototype.addModel=function(a){var b;if(-1===this._models.indexOf(a)){this._models.push(a);var c=a.getMaterials();for(b=0;b<c.length;b++)c[b].scene=this;var e=a.meshInstances.length;for(b=0;b<e;b++)c=a.meshInstances[b],-1===this.drawCalls.indexOf(c)&&
this.drawCalls.push(c),c.castShadow&&-1===this.shadowCasters.indexOf(c)&&this.shadowCasters.push(c);a=a.getLights();b=0;for(len=a.length;b<len;b++)this.addLight(a[b])}};d.prototype.removeModel=function(a){var b,c=this._models.indexOf(a);if(-1!==c){this._models.splice(c,1);c=a.getMaterials();for(b=0;b<c.length;b++)c[b].scene=null;var e,d=a.meshInstances.length;for(b=0;b<d;b++)e=a.meshInstances[b],c=this.drawCalls.indexOf(e),-1!==c&&this.drawCalls.splice(c,1),e.castShadow&&(c=this.shadowCasters.indexOf(e),
-1!==c&&this.shadowCasters.splice(c,1));a=a.getLights();b=0;for(len=a.length;b<len;b++)this.removeLight(a[b])}};d.prototype.containsModel=function(a){return 0<=this._models.indexOf(a)};d.prototype.addLight=function(a){-1!==this._lights.indexOf(a)?console.warn("pc.scene.Scene#addLight: light is already in the scene"):(this._lights.push(a),a._scene=this,this.updateShaders=!0)};d.prototype.removeLight=function(a){var b=this._lights.indexOf(a);-1===b?console.warn("pc.scene.Scene#removeLight: light is not in the scene"):
(this._lights.splice(b,1),a._scene=null,this.updateShaders=!0)};d.prototype.update=function(){for(var a=0,b=this._models.length;a<b;a++)this._models[a].getGraph().syncHierarchy()};return{Scene:d}}());pc.extend(pc.scene,function(){function d(a,b){return a.distSqr&&b.distSqr?b.distSqr-a.distSqr:b.key-a.key}function a(a,b,c){var e=b.getNearClip(),a=a.shadowDistance,d=b.getFov()*Math.PI/180,f=b.getAspectRatio(),b=b.getProjection(),g,h;h=b===pc.scene.Projection.PERSPECTIVE?Math.tan(d/2)*e:this._orthoHeight;g=h*f;c[0].x=g;c[0].y=-h;c[0].z=-e;c[1].x=g;c[1].y=h;c[1].z=-e;c[2].x=-g;c[2].y=h;c[2].z=-e;c[3].x=-g;c[3].y=-h;c[3].z=-e;b===pc.scene.Projection.PERSPECTIVE&&(h=Math.tan(d/2)*a,g=h*f);c[4].x=g;
c[4].y=-h;c[4].z=-a;c[5].x=g;c[5].y=h;c[5].z=-a;c[6].x=-g;c[6].y=h;c[6].z=-a;c[7].x=-g;c[7].y=-h;c[7].z=-a;return c}function b(a,b,c){b=new pc.gfx.Texture(a,{format:pc.gfx.PIXELFORMAT_R8_G8_B8_A8,width:b,height:c});b.minFilter=pc.gfx.FILTER_NEAREST;b.magFilter=pc.gfx.FILTER_NEAREST;b.addressU=pc.gfx.ADDRESS_CLAMP_TO_EDGE;b.addressV=pc.gfx.ADDRESS_CLAMP_TO_EDGE;return new pc.gfx.RenderTarget(a,b,!0)}function c(a){this.device=a;a=this.device.getProgramLibrary();this._depthProgStatic=a.getProgram("depthrgba",
...
new pc.shape.Aabb;this._sceneAabb=new pc.shape.Aabb;this._shadowState={blend:!1};this.centroid=new pc.Vec3;this.fogColor=new Float32Array(3);this.ambientColor=new Float32Array(3)}var e=(new pc.Mat4).setScale(0.5,0.5,0.5),f=(new pc.Mat4).setTranslate(0.5,0.5,0.5),g=(new pc.Mat4).mul2(f,e),k=(new pc.Mat4).setFromAxisAngle(pc.Vec3.RIGHT,-90),l=new pc.Mat4,n=new pc.Mat4,r=new pc.Mat4,m=new pc.Mat4,s=new pc.Mat4,h=[];for(i=0;8>i;i++)h.push(new pc.Vec3);pc.extend(c.prototype,{setCamera:function(a){var b=
a.getProjectionMatrix();this.projId.setValue(b.data);var c=a.getWorldTransform();this.viewInvId.setValue(c.data);m.copy(c).invert();this.viewId.setValue(m.data);s.mul2(b,m);this.viewProjId.setValue(s.data);this.viewPosId.setValue(a.getPosition().data);this.nearClipId.setValue(a.getNearClip());this.farClipId.setValue(a.getFarClip());a._frustum.update(b,m);var b=this.device,e=a.getRenderTarget();b.setRenderTarget(e);b.updateBegin();var c=a.getRect(),d=e?e.width:b.width,f=e?e.height:b.height,e=Math.floor(c.x*
d),g=Math.floor(c.y*f),d=Math.floor(c.width*d),c=Math.floor(c.height*f);b.setViewport(e,g,d,c);b.setScissor(e,g,d,c);b.clear(a.getClearOptions())},dispatchGlobalLights:function(a){var b=a._globalLights,c=b.length,e=this.device.scope;this.ambientColor[0]=a.ambientLight.r;this.ambientColor[1]=a.ambientLight.g;this.ambientColor[2]=a.ambientLight.b;e.resolve("light_globalAmbient").setValue(this.ambientColor);for(a=0;a<c;a++){var d=b[a],f=d.getWorldTransform(),g="light"+a;e.resolve(g+"_color").setValue(d._finalColor.data);
f.getY(d._direction).scale(-1);e.resolve(g+"_direction").setValue(d._direction.data);d.getCastShadows()&&(f=this.device.extDepthTexture?d._shadowCamera._renderTarget._depthTexture:d._shadowCamera._renderTarget.colorBuffer,e.resolve(g+"_shadowMap").setValue(f),e.resolve(g+"_shadowMatrix").setValue(d._shadowMatrix.data),e.resolve(g+"_shadowParams").setValue([d._shadowResolution,d._shadowResolution,d._shadowBias]))}},dispatchLocalLights:function(a){var b,c,e,d,f=a._localLights;e=f[pc.scene.LIGHTTYPE_POINT-
1];for(var f=f[pc.scene.LIGHTTYPE_SPOT-1],g=a._globalLights.length,h=e.length,k=f.length,l=this.device.scope,a=0;a<h;a++)c=e[a],b=c.getWorldTransform(),d="light"+(g+a),l.resolve(d+"_radius").setValue(c._attenuationEnd),l.resolve(d+"_color").setValue(c._finalColor.data),b.getTranslation(c._position),l.resolve(d+"_position").setValue(c._position.data);for(a=0;a<k;a++)e=f[a],b=e.getWorldTransform(),d="light"+(g+h+a),l.resolve(d+"_innerConeAngle").setValue(e._innerConeAngleCos),l.resolve(d+"_outerConeAngle").setValue(e._outerConeAngleCos),
l.resolve(d+"_radius").setValue(e._attenuationEnd),l.resolve(d+"_color").setValue(e._finalColor.data),b.getTranslation(e._position),l.resolve(d+"_position").setValue(e._position.data),b.getY(e._direction).scale(-1),l.resolve(d+"_spotDirection").setValue(e._direction.data),e.getCastShadows()&&(b=this.device.extDepthTexture?e._shadowCamera._renderTarget._depthTexture:e._shadowCamera._renderTarget.colorBuffer,l.resolve(d+"_shadowMap").setValue(b),l.resolve(d+"_shadowMatrix").setValue(e._shadowMatrix.data),
l.resolve(d+"_shadowParams").setValue([e._shadowResolution,e._shadowResolution,e._shadowBias]))},render:function(c,e){var f=this.device,m=f.scope;c.updateShaders&&(c._updateShaders(f),c.updateShaders=!1);pc.scene.Scene.current=c;var s=c._lights,A=c.drawCalls,z=c.shadowCasters,C,D,G,x,B,E,K=null;C=0;for(numDrawCalls=c.drawCalls.length;C<numDrawCalls;C++)x=c.drawCalls[C],x.skinInstance&&x.skinInstance.updateMatrixPalette();c._globalLights.length=0;c._localLights[0].length=0;for(C=c._localLights[1].length=
0;C<s.length;C++)x=s[C],x.getEnabled()&&(x.getType()===pc.scene.LIGHTTYPE_DIRECTIONAL?x.getCastShadows()?c._globalLights.push(x):c._globalLights.unshift(x):c._localLights[x.getType()===pc.scene.LIGHTTYPE_POINT?0:1].push(x));B=e.getPosition();C=0;for(numDrawCalls=A.length;C<numDrawCalls;C++)x=A[C],x.command||(x.material.blendType===pc.scene.BLEND_NORMAL?(x.syncAabb(),G=x.aabb.center,D=G.x-B.x,E=G.y-B.y,G=G.z-B.z,x.distSqr=D*D+E*E+G*G):"undefined"!==typeof x.distSqr&&delete x.distSqr);A.sort(d);if(e._depthTarget){D=
e.getRenderTarget();e.setRenderTarget(e._depthTarget);this.setCamera(e);E=f.getBlending();f.setBlending(!1);C=0;for(numDrawCalls=A.length;C<numDrawCalls;C++)x=A[C],!x.command&&x.layer!==pc.scene.LAYER_SKYBOX&&(B=x.mesh,this.modelMatrixId.setValue(x.node.worldTransform.data),x.skinInstance?(this.poseMatrixId.setValue(x.skinInstance.matrixPalette),f.setShader(this._depthShaderSkin)):f.setShader(this._depthShaderStatic),x=x.renderStyle,f.setVertexBuffer(B.vertexBuffer,0),f.setIndexBuffer(B.indexBuffer[x]),
f.draw(B.primitive[x])),e.setRenderTarget(D);f.setBlending(E)}for(C=0;C<s.length;C++)if(x=s[C],D=x.getType(),D!==pc.scene.LIGHTTYPE_POINT&&x.getCastShadows()&&x.getEnabled()){B=f;E=x;G=E._shadowCamera;var H=void 0;if(null===G)G=pc.gfx.CLEARFLAG_DEPTH,B.extDepthTexture||(G|=pc.gfx.CLEARFLAG_COLOR),H=new pc.scene.CameraNode,H.setClearOptions({color:[1,1,1,1],depth:1,flags:G}),G=H,H=b(B,E._shadowResolution,E._shadowResolution),G.setRenderTarget(H),E._shadowCamera=G;else if(H=G.getRenderTarget(),H.width!==
E._shadowResolution||H.height!==E._shadowResolution)H=b(B,E._shadowResolution,E._shadowResolution),G.setRenderTarget(H);B=G;if(D===pc.scene.LIGHTTYPE_DIRECTIONAL){D=e;E=this.centroid;E.set(0,0,0.5*-(c.shadowDistance+D._nearClip));D.getWorldTransform().transformPoint(E,E);B.setPosition(this.centroid);D=new pc.Vec3;x.worldTransform.getY(D);B.translate(D);B.lookAt(this.centroid);l.copy(B.getWorldTransform());a(c,e,h);D=l.invert();G=e.worldTransform;E=new pc.Mat4;E.mul2(D,G);for(D=0;8>D;D++)E.transformPoint(h[D],
h[D]);E=1E6;G=-1E6;var H=1E6,I=-1E6,J=1E6,L=-1E6;for(D=0;8>D;D++){var N=h[D];N.x<E&&(E=N.x);N.x>G&&(G=N.x);N.y<H&&(H=N.y);N.y>I&&(I=N.y);N.z<J&&(J=N.z);N.z>L&&(L=N.z)}B.translateLocal(0.5*-(G+E),0.5*(I+H),L+0.25*(L-J));l.copy(B.getWorldTransform());B.setProjection(pc.scene.Projection.ORTHOGRAPHIC);B.setNearClip(0);B.setFarClip(1.5*(L-J));B.setAspectRatio((G-E)/(I-H));B.setOrthoHeight(0.5*(I-H))}else D===pc.scene.LIGHTTYPE_SPOT&&(B.setProjection(pc.scene.Projection.PERSPECTIVE),B.setNearClip(x.getAttenuationEnd()/
1E3),B.setFarClip(x.getAttenuationEnd()),B.setAspectRatio(1),B.setFov(2*x.getOuterConeAngle()),l.mul2(x.worldTransform,k));n.copy(l).invert();r.mul2(B.getProjectionMatrix(),n);x._shadowMatrix.mul2(g,r);B.worldTransform.copy(l);f.setBlending(!1);f.setColorWrite(!0,!0,!0,!0);f.setCullMode(pc.gfx.CULLFACE_BACK);f.setDepthWrite(!0);f.setDepthTest(!0);f.extDepthTexture&&f.setColorWrite(!1,!1,!1,!1);this.setCamera(B);D=0;for(G=z.length;D<G;D++)x=z[D],B=x.mesh,E=x.material,this.modelMatrixId.setValue(x.node.worldTransform.data),
E.opacityMap&&m.resolve("texture_opacityMap").setValue(E.opacityMap),x.skinInstance?(this.poseMatrixId.setValue(x.skinInstance.matrixPalette),f.setShader(E.opacityMap?this._depthProgSkinOp:this._depthProgSkin)):f.setShader(E.opacityMap?this._depthProgStaticOp:this._depthProgStatic),x=x.renderStyle,f.setVertexBuffer(B.vertexBuffer,0),f.setIndexBuffer(B.indexBuffer[x]),f.draw(B.primitive[x])}this.setCamera(e);this.dispatchGlobalLights(c);this.dispatchLocalLights(c);c.fog!==pc.scene.FOG_NONE&&(this.fogColor[0]=
c.fogColor.r,this.fogColor[1]=c.fogColor.g,this.fogColor[2]=c.fogColor.b,this.fogColorId.setValue(this.fogColor),c.fog===pc.scene.FOG_LINEAR?(this.fogStartId.setValue(c.fogStart),this.fogEndId.setValue(c.fogEnd)):this.fogDensityId.setValue(c.fogDensity));C=0;for(numDrawCalls=A.length;C<numDrawCalls;C++)if(x=A[C],x.command)x.command();else{B=x.mesh;E=x.material;m=x.node.worldTransform;s=x.normalMatrix;m.invertTo3x3(s);s.transpose();this.modelMatrixId.setValue(m.data);this.normalMatrixId.setValue(s.data);
x.skinInstance&&this.poseMatrixId.setValue(x.skinInstance.matrixPalette);if(E!==K){E.shader||E.updateShader(f,c);f.setShader(E.shader);var K=E.parameters,P;for(P in K)m=K[P],m.scopeId||(m.scopeId=f.scope.resolve(P)),m.scopeId.setValue(m.data);this.alphaTestId.setValue(E.alphaTest);f.setBlending(E.blend);f.setBlendFunction(E.blendSrc,E.blendDst);f.setBlendEquation(E.blendEquation);f.setColorWrite(E.redWrite,E.greenWrite,E.blueWrite,E.alphaWrite);f.setCullMode(E.cull);f.setDepthWrite(E.depthWrite);
f.setDepthTest(E.depthTest)}f.setVertexBuffer(B.vertexBuffer,0);x=x.renderStyle;f.setIndexBuffer(B.indexBuffer[x]);f.draw(B.primitive[x]);K=E}}});return{ForwardRenderer:c}}());pc.extend(pc.scene,function(){var d=function(a){this.name=a||"Untitled";this._labels={};this.localPosition=new pc.Vec3(0,0,0);this.localRotation=new pc.Quat(0,0,0,1);this.localScale=new pc.Vec3(1,1,1);this.localEulerAngles=new pc.Vec3(0,0,0);this.position=new pc.Vec3(0,0,0);this.rotation=new pc.Quat(0,0,0,1);this.eulerAngles=new pc.Vec3(0,0,0);this.localTransform=new pc.Mat4;this.dirtyLocal=!1;this.worldTransform=new pc.Mat4;this.dirtyWorld=!1;this._right=new pc.Vec3;this._up=new pc.Vec3;this._forward=
...
c=this.getWorldTransform().clone().invert();pvm=new pc.Mat4;width=this._renderTarget.getWidth();height=this._renderTarget.getHeight();point2d=new pc.Vec3;b=(new pc.Mat4).setPerspective(this._fov,width/height,this._nearClip,this._farClip);pvm.mul2(b,c);pvm.transformPoint(a,point2d);point2d.x=width/2+width/2*point2d.x;point2d.y=height-(height/2+height/2*point2d.y);point2d.z=point2d.z;return point2d},screenToWorld:function(a,b,c,e,d,g){"undefined"===typeof g&&(g=new pc.Vec3);var k=this.getProjectionMatrix(),
l=this.getWorldTransform();this._viewMat.copy(l);this._viewMat.invert();this._viewProjMat.mul2(k,this._viewMat);k=this._viewProjMat.clone().invert();this._projection===pc.scene.Projection.PERSPECTIVE?(b=new pc.Vec3(2*(a/e)-1,2*((d-b)/d)-1,1),a=k.transformPoint(b),a.scale(1/(b.x*k.data[3]+b.y*k.data[7]+b.z*k.data[11]+k.data[15])),c/=this._farClip,g.lerp(this.getPosition(),a,c)):(c=new pc.Vec3(2*(a/e)-1,2*((d-b)/d)-1,2*((this._farClip-c)/(this._farClip-this._nearClip))-1),k.transformPoint(c,g));return g},
...
a.update();return a},init:function(a){this.name=a.name;for(var b=0;b<a.parameters.length;b++){var c=a.parameters[b];switch(c.name){case "ambient":this.ambient=k(c);break;case "diffuse":this.diffuse=k(c);break;case "diffuseMap":this.diffuseMap=e(c);break;case "diffuseMapTiling":this.diffuseMapTiling=f(c);break;case "diffuseMapOffset":this.diffuseMapOffset=f(c);break;case "diffuseMapRotation":this.diffuseMapRotation=g(c);break;case "specular":this.specular=k(c);break;case "specularMap":this.specularMap=
e(c);break;case "specularMapTiling":this.specularMapTiling=f(c);break;case "specularMapOffset":this.specularMapOffset=f(c);break;case "specularMapRotation":this.specularMapRotation=g(c);break;case "shininess":this.shininess=c.data;break;case "glossMap":this.glossMap=e(c);break;case "glossMapTiling":this.glossMapTiling=f(c);break;case "glossMapOffset":this.glossMapOffset=f(c);break;case "glossMapRotation":this.glossMapRotation=g(c);break;case "emissive":this.emissive=k(c);break;case "emissiveMap":this.emissiveMap=
e(c);break;case "emissiveMapTiling":this.emissiveMapTiling=f(c);break;case "emissiveMapOffset":this.emissiveMapOffset=f(c);break;case "emissiveMapRotation":this.emissiveMapRotation=g(c);break;case "opacity":this.opacity=c.data;break;case "opacityMap":this.opacityMap=e(c);break;case "opacityMapTiling":this.opacityMapTiling=f(c);break;case "opacityMapOffset":this.opacityMapOffset=f(c);break;case "opacityMapRotation":this.opacityMapRotation=g(c);break;case "normalMap":this.normalMap=e(c);break;case "normalMapTiling":this.normalMapTiling=
f(c);break;case "normalMapOffset":this.normalMapOffset=f(c);break;case "normalMapRotation":this.normalMapRotation=g(c);break;case "heightMap":this.heightMap=e(c);break;case "heightMapTiling":this.heightMapTiling=f(c);break;case "heightMapOffset":this.heightMapOffset=f(c);break;case "heightMapRotation":this.heightMapRotation=g(c);break;case "bumpMapFactor":this.bumpiness=c.data;break;case "cubeMap":this.cubeMap=e(c);break;case "sphereMap":this.sphereMap=e(c);break;case "reflectivity":this.reflectivity=
c.data;break;case "lightMap":this.lightMap=e(c);break;case "depthTest":this.depthTest=c.data;break;case "depthWrite":this.depthWrite=c.data;break;case "cull":this.cull=c.data;break;case "blendType":this.blendType=c.data}}this.blendType=this.opacityMap||1>this.opacity?this.blendType||pc.scene.BLEND_NORMAL:pc.scene.BLEND_NONE;this.update()},_updateMapTransform:function(c,e,f,g){e?d.set(e.x,e.y,1):d.set(1,1,1);f?b.set(f.x,f.y,0):b.set(0,0,0);g?a.setFromEulerAngles(g.x,g.y,g.z):a.copy(pc.Quat.IDENTITY);
...
b._lights,e=0,d=0,f=0,g=0,k=0,y=0;y<c.length;y++){var u=c[y];if(u.getEnabled())switch(u.getType()){case pc.scene.LIGHTTYPE_DIRECTIONAL:u.getCastShadows()?g++:e++;break;case pc.scene.LIGHTTYPE_POINT:d++;break;case pc.scene.LIGHTTYPE_SPOT:u.getCastShadows()?k++:f++}}c={fog:b.fog,skin:!!this.meshInstances[0].skinInstance,numDirs:e,numSDirs:g,numPnts:d,numSPnts:0,numSpts:f,numSSpts:k,diffuseMap:!!this.diffuseMap,diffuseMapTransform:!!this.diffuseMapTransform,specularMap:!!this.specularMap,specularMapTransform:!!this.specularMapTransform,
...
this.indices.push(d);this.vertices.push(a);this.indexMap[c]=d}},addPrimitive:function(a,c,e,d){var g,k,l=[],n=0,r=a.length;for(g=0;g<r;g++)for(var m=a[g].index,s=0;4>s;s++)if(0<e.blendWeight.data[4*m+s]){var h=e.blendIndices.data[4*m+s],v=!0;for(k=0;k<n;k++)if(l[k]==h){v=!1;break}v&&(l[n]=h,k=this.getBoneRemap(h),n+=-1===k?1:0)}if(this.boneIndices.length+n>d)return!1;for(g=0;g<n;g++)this.boneIndices.push(l[g]);for(g=0;g<r;g++)this.addVertex(a[g],c[g],e);return!0},getBoneRemap:function(a){for(var c=
0;c<this.boneIndices.length;c++)if(this.boneIndices[c]===a)return c;return-1}};return{partitionSkin:function(b,c,e){var f,g,k,l=b.vertices,n=b.skins,r=b.meshes,m=b.meshInstances;for(f=0;f<r.length;f++)r[f].vertices=l[r[f].vertices],"undefined"!==typeof r[f].skin&&(r[f].skin=n[r[f].skin]);for(f=0;f<m.length;f++)m[f].mesh=r[m[f].mesh];l=b.vertices;n=b.skins;r=b.meshes;m=b.meshInstances;for(f=n.length-1;0<=f;f--)if(n[f].boneNames.length>e){var s=n.splice(f,1)[0],h=[];for(g=0;g<r.length;g++)r[g].skin===
s&&h.push(r[g]);for(g=0;g<h.length;g++){var v=r.indexOf(h[g]);-1!==v&&r.splice(v,1)}if(0===h.length)throw Error("partitionSkin: There should be at least one mesh that references a skin");var F=h[0].vertices;for(g=1;g<h.length;g++)if(h[g].vertices!==F)throw Error("partitionSkin: All meshes that share a skin should also share the same vertex buffer");var y=[],u=function(a){var b=new d;b.index=a;return b};k=[];var w=[],A=0;for(g=0;g<h.length;g++){for(var z=h[g],C=z.indices,D=z.base;D<z.base+z.count;){v=
C[D++];k[0]=u(v);w[0]=v;v=C[D++];k[1]=u(v);w[1]=v;v=C[D++];k[2]=u(v);w[2]=v;for(var G=!1,x=A;x<y.length;x++)if(v=y[x],v.addPrimitive(k,w,F,e)){G=!0;break}G||(v=new a,v.originalMesh=z,v.addPrimitive(k,w,F,e),y.push(v))}A=y.length}z=[];h=[];for(g=0;g<y.length;g++)if(v=y[g],v.vertices.length&&v.indices.length){u=z.length;k=v.vertices.length;w=h.length;A=v.indices.length;v.partition=g;v.vertexStart=u;v.vertexCount=k;v.indexStart=w;v.indexCount=A;C=0;for(D=u;C<k;)z[D++]=v.vertices[C++];C=0;for(D=w;C<A;)h[D++]=
v.indices[C++]+u}u=[];for(g=0;g<y.length;g++){v=y[g];w=[];A=[];for(k=0;k<v.boneIndices.length;k++)w.push(s.inverseBindMatrices[v.boneIndices[k]]),A.push(s.boneNames[v.boneIndices[k]]);v={inverseBindMatrices:w,boneNames:A};u.push(v);n.push(v)}var B,s={};for(B in F)s[B]={components:F[B].components,data:[],type:F[B].type};for(B in F)if("blendIndices"===B){v=s[B].data;for(g=0;g<z.length;g++)k=z[g].boneIndices,v.push(k[0],k[1],k[2],k[3])}else{g=F[B];data=g.data;components=g.components;for(g=0;g<z.length;g++){v=
z[g].index;for(k=0;k<components;k++)s[B].data.push(data[v*components+k])}}l[l.indexOf(F)]=s;for(g=0;g<y.length;g++){v=y[g];z={aabb:{min:[0,0,0],max:[0,0,0]},vertices:s,skin:u[g],indices:h.splice(0,v.indexCount),type:"triangles",base:0,count:v.indexCount};r.push(z);for(k=m.length-1;0<=k;k--)m[k].mesh===v.originalMesh&&(m.push({mesh:z,node:m[k].node}),c&&c.push({material:c[k].material,path:c[k].path}))}for(g=0;g<y.length;g++){v=y[g];for(k=m.length-1;0<=k;k--)m[k].mesh===v.originalMesh&&(m.splice(k,
1),c&&c.splice(k,1))}}c=b.vertices;e=b.skins;B=b.meshes;f=b.meshInstances;for(b=0;b<B.length;b++)B[b].vertices=c.indexOf(B[b].vertices),"undefined"!==typeof B[b].skin&&(B[b].skin=e.indexOf(B[b].skin));for(b=0;b<f.length;b++)f[b].mesh=B.indexOf(f[b].mesh)}}}());pc.extend(pc.scene,function(){var d=function(){this.graph=null;this.meshInstances=[];this.skinInstances=[];this.cameras=[];this.lights=[]};d.prototype.getGraph=function(){return this.graph};d.prototype.setGraph=function(a){this.graph=a};d.prototype.getCameras=function(){return this.cameras};d.prototype.setCameras=function(a){this.cameras=a};d.prototype.getLights=function(){return this.lights};d.prototype.setLights=function(a){this.lights=a};d.prototype.getTextures=function(){return this.textures};
d.prototype.getMaterials=function(){var a,b=[];for(a=0;a<this.meshInstances.length;a++){var c=this.meshInstances[a];-1===b.indexOf(c.material)&&b.push(c.material)}return b};d.prototype.clone=function(){var a,b=[],c=[],e=function(a){var d=a.clone();b.push(a);c.push(d);a instanceof pc.scene.CameraNode?s.cameras.push(d):a instanceof pc.scene.LightNode&&s.lights.push(d);for(var a=a.getChildren(),f=0;f<a.length;f++)d.addChild(e(a[f]));return d},d=e(this.graph),g=[],k=[];for(a=0;a<this.skinInstances.length;a++){var l=
this.skinInstances[a].skin,n=new pc.scene.SkinInstance(l),r=[];for(j=0;j<l.boneNames.length;j++){var m=d.findByName(l.boneNames[j]);r.push(m)}n.bones=r;k.push(n)}for(a=0;a<this.meshInstances.length;a++)l=this.meshInstances[a],n=b.indexOf(l.node),n=new pc.scene.MeshInstance(c[n],l.mesh,l.material),l.skinInstance&&(l=this.skinInstances.indexOf(l.skinInstance),n.skinInstance=k[l]),g.push(n);var s=new pc.scene.Model;s.graph=d;s.meshInstances=g;s.skinInstances=k;s.getGraph().syncHierarchy();d=s.meshInstances;
for(a=0;a<d.length;a++)d[a].syncAabb();return s};d.prototype.generateWireframe=function(){var a,b,c,e,d,g,k,l,n,r,m=[];for(a=0;a<this.meshInstances.length;a++)g=this.meshInstances[a].mesh,-1===m.indexOf(g)&&m.push(g);var s=[[0,1],[1,2],[2,0]];for(a=0;a<m.length;a++){g=m[a];k=g.primitive[pc.scene.RENDERSTYLE_SOLID].base;l=g.primitive[pc.scene.RENDERSTYLE_SOLID].count;n=g.indexBuffer[pc.scene.RENDERSTYLE_SOLID];r=new Uint16Array(n.lock());var h={},v=[];for(b=k;b<k+l;b+=3)for(c=0;3>c;c++){e=r[b+s[c][0]];
d=r[b+s[c][1]];var F=e>d?d<<16|e:e<<16|d;void 0===h[F]&&(h[F]=0,v.push(e,d))}n.unlock();b=new pc.gfx.IndexBuffer(n.device,pc.gfx.INDEXFORMAT_UINT16,v.length);c=new Uint16Array(b.lock());c.set(v);b.unlock();g.primitive[pc.scene.RENDERSTYLE_WIREFRAME]={type:pc.gfx.PRIMITIVE_LINES,base:0,count:v.length,indexed:!0};g.indexBuffer[pc.scene.RENDERSTYLE_WIREFRAME]=b}};return{Model:d}}());pc.extend(pc.scene,function(){var d=new pc.Vec3,a=new pc.Vec3,b=new pc.Vec3,c=new pc.Vec4,e=[[-0.5,-0.5],[0.5,-0.5],[0.5,0.5],[-0.5,0.5]],f=function(a){return 2*(Math.random()-0.5)*a},g=function(a){var b=new pc.Vec3;b.set(f(a.x),f(a.y),f(a.z));return b},k=function(a){var b=new pc.Vec4;b.set(f(a.x),f(a.y),f(a.z),f(a.w));return b},l=function(a,b,c,e){a=new pc.gfx.Texture(a,{width:b,height:c,format:pc.gfx.PIXELFORMAT_R8_G8_B8_A8,cubemap:!1,autoMipmap:!0});a.lock().set(e);a.unlock();a.addressU=pc.gfx.ADDRESS_CLAMP_TO_EDGE;
...
b);this.vertexBuffer=new pc.gfx.VertexBuffer(this.graphicsDevice,b,4*a,pc.gfx.BUFFER_DYNAMIC);this.indexBuffer=new pc.gfx.IndexBuffer(this.graphicsDevice,pc.gfx.INDEXFORMAT_UINT16,6*a);for(var b=0,c=new Uint16Array(this.indexBuffer.lock()),e=0;e<a;e++){var d=4*e;c[b++]=d;c[b++]=d+1;c[b++]=d+2;c[b++]=d;c[b++]=d+2;c[b++]=d+3}this.indexBuffer.unlock()}},generate:function(l,n){for(var s=new Float32Array(this.vertexBuffer.lock()),h=this.billboard?24:28,v=l;v<n;v++){var F=this.lifeTime,y=v*F/n,u=this.frameStart+
f(this.frameStartRange);d.add2(this.position,g(this.positionRange));a.add2(this.velocity,g(this.velocityRange));b.add2(this.acceleration,g(this.accelerationRange));c.add2(this.colorMult,k(this.colorMultRange));for(var w=this.spinStart+f(this.spinStartRange),A=this.spinSpeed+f(this.spinSpeedRange),z=this.startSize+f(this.startSizeRange),C=this.endSize+f(this.endSizeRange),D=this.orientation,G=0;4>G;G++){var x=(4*v+G)*h;s[x+0]=e[G][0];s[x+1]=e[G][1];s[x+2]=F;s[x+3]=u;s[x+4]=d.x;s[x+5]=d.y;s[x+6]=d.z;
s[x+7]=y;s[x+8]=a.x;s[x+9]=a.y;s[x+10]=a.z;s[x+11]=z;s[x+12]=b.x;s[x+13]=b.y;s[x+14]=b.z;s[x+15]=C;s[x+16]=w;s[x+17]=A;s[x+18]=0;s[x+19]=0;s[x+20]=c.x;s[x+21]=c.y;s[x+22]=c.z;s[x+23]=c.w;this.billboard||(s[x+24]=D.x,s[x+25]=D.y,s[x+26]=D.z,s[x+27]=D.w)}}this.vertexBuffer.unlock()},addTime:function(a){this.time+=a;this.meshInstance.material.setParameter("particle_time",this.time);this.dynamic&&(this.generate(this.birthIndex+this.numParticles,this.numParticles),this.birthIndex+=this.numParticles)},
...
0,this._pickBufferTarget.width,this._pickBufferTarget.height);c.clear(this.clearOptions);var d,g,k,l,n=b.drawCalls,r=n.length,c=this.device;g=c.scope;var m=g.resolve("matrix_model"),s=g.resolve("matrix_pose[0]"),h=g.resolve("uColor");d=g.resolve("matrix_projection");g=g.resolve("matrix_viewProjection");l=a.getWorldTransform();k=a.getProjectionMatrix();l=l.clone().invert();var v=new pc.Mat4;v.mul2(k,l);d.setValue(k.data);g.setValue(v.data);for(d=0;d<r;d++)if(!n[d].command&&(k=n[d],g=k.mesh,l=g.primitive[pc.scene.RENDERSTYLE_SOLID].type,
l===pc.gfx.PRIMITIVE_TRIANGLES||l===pc.gfx.PRIMITIVE_TRISTRIP))m.setValue(k.node.worldTransform.data),k.skinInstance&&s.setValue(k.skinInstance.matrixPalette),this.pickColor[0]=(d>>16&255)/255,this.pickColor[1]=(d>>8&255)/255,this.pickColor[2]=(d&255)/255,this.pickColor[3]=1,h.setValue(this.pickColor),c.setShader(g.skin?this.pickProgSkin:this.pickProgStatic),c.setVertexBuffer(g.vertexBuffer,0),c.setIndexBuffer(g.indexBuffer[pc.scene.RENDERSTYLE_SOLID]),c.draw(g.primitive[pc.scene.RENDERSTYLE_SOLID]);
...
pc.scene.procedural.calculateTangents=function(d,a,b,c){var e=c.length/3,f=d.length/3,g,k,l,n,r,m,s,h,v,F,y,u,w,A,z=new pc.Vec3,C=new pc.Vec3,D=new pc.Vec3,G=new pc.Vec3,x=new pc.Vec3,B=new pc.Vec2,E=new pc.Vec2,K=new pc.Vec2,H,I=new Float32Array(3*f),J=new Float32Array(3*f),L=[];for(H=0;H<e;H++)g=c[3*H],k=c[3*H+1],l=c[3*H+2],D.set(d[3*g],d[3*g+1],d[3*g+2]),G.set(d[3*k],d[3*k+1],d[3*k+2]),x.set(d[3*l],d[3*l+1],d[3*l+2]),B.set(b[2*g],b[2*g+1]),E.set(b[2*k],b[2*k+1]),K.set(b[2*l],b[2*l+1]),n=G.x-D.x,
r=x.x-D.x,m=G.y-D.y,s=x.y-D.y,h=G.z-D.z,v=x.z-D.z,F=E.x-B.x,y=K.x-B.x,u=E.y-B.y,w=K.y-B.y,A=1/(F*w-y*u),z.set((w*n-u*r)*A,(w*m-u*s)*A,(w*h-u*v)*A),C.set((F*r-y*n)*A,(F*s-y*m)*A,(F*v-y*h)*A),I[3*g+0]+=z.x,I[3*g+1]+=z.y,I[3*g+2]+=z.z,I[3*k+0]+=z.x,I[3*k+1]+=z.y,I[3*k+2]+=z.z,I[3*l+0]+=z.x,I[3*l+1]+=z.y,I[3*l+2]+=z.z,J[3*g+0]+=C.x,J[3*g+1]+=C.y,J[3*g+2]+=C.z,J[3*k+0]+=C.x,J[3*k+1]+=C.y,J[3*k+2]+=C.z,J[3*l+0]+=C.x,J[3*l+1]+=C.y,J[3*l+2]+=C.z;u=new pc.Vec3;w=new pc.Vec3;d=new pc.Vec3;b=new pc.Vec3;for(H=
0;H<f;H++)d.set(a[3*H],a[3*H+1],a[3*H+2]),u.set(I[3*H],I[3*H+1],I[3*H+2]),w.set(J[3*H],J[3*H+1],J[3*H+2]),c=d.dot(u),b.copy(d).scale(c),b.sub2(u,b).normalize(),L[4*H]=b.x,L[4*H+1]=b.y,L[4*H+2]=b.z,b.cross(d,u),L[4*H+3]=0>b.dot(w)?-1:1;return L};
pc.scene.procedural.createMesh=function(d,a,b){var c=b&&void 0!==b.normals?b.normals:null,e=b&&void 0!==b.tangents?b.tangents:null,f=b&&void 0!==b.uvs?b.uvs:null,b=b&&void 0!==b.indices?b.indices:null,g=[{semantic:pc.gfx.SEMANTIC_POSITION,components:3,type:pc.gfx.ELEMENTTYPE_FLOAT32}];null!==c&&g.push({semantic:pc.gfx.SEMANTIC_NORMAL,components:3,type:pc.gfx.ELEMENTTYPE_FLOAT32});null!==e&&g.push({semantic:pc.gfx.SEMANTIC_TANGENT,components:4,type:pc.gfx.ELEMENTTYPE_FLOAT32});null!==f&&g.push({semantic:pc.gfx.SEMANTIC_TEXCOORD0,
components:2,type:pc.gfx.ELEMENTTYPE_FLOAT32});for(var k=new pc.gfx.VertexFormat(d,g),g=a.length/3,k=new pc.gfx.VertexBuffer(d,k,g),l=new pc.gfx.VertexIterator(k),n=0;n<g;n++)l.element[pc.gfx.SEMANTIC_POSITION].set(a[3*n],a[3*n+1],a[3*n+2]),null!==c&&l.element[pc.gfx.SEMANTIC_NORMAL].set(c[3*n],c[3*n+1],c[3*n+2]),null!==e&&l.element[pc.gfx.SEMANTIC_TANGENT].set(e[4*n],e[4*n+1],e[4*n+2],e[4*n+3]),null!==f&&l.element[pc.gfx.SEMANTIC_TEXCOORD0].set(f[2*n],f[2*n+1]),l.next();l.end();c=null;if(e=null!==
b)c=new pc.gfx.IndexBuffer(d,pc.gfx.INDEXFORMAT_UINT16,b.length),(new Uint16Array(c.lock())).set(b),c.unlock();d=new pc.shape.Aabb;d.compute(a);a=new pc.scene.Mesh;a.vertexBuffer=k;a.indexBuffer[0]=c;a.primitive[0].type=pc.gfx.PRIMITIVE_TRIANGLES;a.primitive[0].base=0;a.primitive[0].count=e?b.length:g;a.primitive[0].indexed=e;a.aabb=d;return a};
pc.scene.procedural.createTorus=function(d,a){var b=a&&void 0!==a.tubeRadius?a.tubeRadius:0.2,c=a&&void 0!==a.ringRadius?a.ringRadius:0.3,e=a&&void 0!==a.segments?a.segments:30,f=a&&void 0!==a.sides?a.sides:20,g,k,l,n,r,m,s,h,v,F,y=[],u=[],w=[],A=[];for(g=0;g<=f;g++)for(k=0;k<=e;k++)l=Math.cos(2*Math.PI*k/e)*(c+b*Math.cos(2*Math.PI*g/f)),n=Math.sin(2*Math.PI*g/f)*b,r=Math.sin(2*Math.PI*k/e)*(c+b*Math.cos(2*Math.PI*g/f)),m=Math.cos(2*Math.PI*k/e)*Math.cos(2*Math.PI*g/f),s=Math.sin(2*Math.PI*g/f),h=
Math.sin(2*Math.PI*k/e)*Math.cos(2*Math.PI*g/f),v=g/f,F=1-k/e,y.push(l,n,r),u.push(m,s,h),w.push(v,F),g<f&&k<e&&(l=g*(e+1)+k,n=(g+1)*(e+1)+k,r=g*(e+1)+(k+1),m=(g+1)*(e+1)+(k+1),A.push(l,n,r),A.push(n,m,r));b={normals:u,uvs:w,indices:A};pc.gfx.precalculatedTangents&&(b.tangents=pc.scene.procedural.calculateTangents(y,u,w,A));return pc.scene.procedural.createMesh(d,y,b)};
pc.scene.procedural._createConeData=function(d,a,b,c,e,f){var g,k,l,n,r,m=new pc.Vec3;l=new pc.Vec3;n=new pc.Vec3;var s,h,v=[],F=[],y=[],u=[],w;if(0<b)for(g=0;g<=c;g++)for(k=0;k<=e;k++)theta=2*(k/e)*Math.PI-Math.PI,w=Math.sin(theta),h=Math.cos(theta),s=new pc.Vec3(w*d,-b/2,h*d),r=new pc.Vec3(w*a,b/2,h*a),m.lerp(s,r,g/c),l.sub2(r,s).normalize(),h=new pc.Vec3(h,0,-w),n.cross(h,l).normalize(),v.push(m.x,m.y,m.z),F.push(n.x,n.y,n.z),y.push(k/e,g/c),g<c&&k<e&&(h=g*(e+1)+k,w=g*(e+1)+(k+1),r=(g+1)*(e+1)+
k,s=(g+1)*(e+1)+(k+1),u.push(h,w,r),u.push(w,s,r));if(f){d=Math.floor(e/2);m=b/2;for(b=0;b<=d;b++){theta=0.5*b*Math.PI/d;w=Math.sin(theta);h=Math.cos(theta);for(g=0;g<=e;g++)phi=2*g*Math.PI/e-Math.PI/2,l=Math.sin(phi),f=Math.cos(phi),f*=w,k=h,l*=w,n=1-g/e,r=1-b/d,v.push(f*a,k*a+m,l*a),F.push(f,k,l),y.push(n,r)}s=(c+1)*(e+1);for(b=0;b<d;++b)for(g=0;g<e;++g)h=b*(e+1)+g,w=h+e+1,u.push(s+h+1,s+w,s+h),u.push(s+h+1,s+w+1,s+w);for(b=0;b<=d;b++){theta=0.5*Math.PI+0.5*b*Math.PI/d;w=Math.sin(theta);h=Math.cos(theta);
for(g=0;g<=e;g++)phi=2*g*Math.PI/e-Math.PI/2,l=Math.sin(phi),f=Math.cos(phi),f*=w,k=h,l*=w,n=1-g/e,r=1-b/d,v.push(f*a,k*a-m,l*a),F.push(f,k,l),y.push(n,r)}s=(c+1)*(e+1)+(e+1)*(d+1);for(b=0;b<d;++b)for(g=0;g<e;++g)h=b*(e+1)+g,w=h+e+1,u.push(s+h+1,s+w,s+h),u.push(s+h+1,s+w+1,s+w)}else{s=(c+1)*(e+1);if(0<d)for(g=0;g<e;g++)theta=2*(g/e)*Math.PI,f=Math.sin(theta),k=-b/2,l=Math.cos(theta),n=1-(f+1)/2,r=(l+1)/2,v.push(f*d,k,l*d),F.push(0,-1,0),y.push(n,r),1<g&&u.push(s,s+g,s+g-1);s+=e;if(0<a)for(g=0;g<e;g++)theta=
2*(g/e)*Math.PI,f=Math.sin(theta),k=b/2,l=Math.cos(theta),n=1-(f+1)/2,r=(l+1)/2,v.push(f*a,k,l*a),F.push(0,1,0),y.push(n,r),1<g&&u.push(s,s+g-1,s+g)}return{positions:v,normals:F,uvs:y,indices:u}};
...
pc.scene.procedural.createSphere=function(d,a){var b=a&&void 0!==a.radius?a.radius:0.5,c=a&&void 0!==a.latitudeBands?a.latitudeBands:16,e=a&&void 0!==a.longitudeBands?a.longitudeBands:16,f,g,k,l,n,r,m,s,h,v=[],F=[],y=[],u=[];for(g=0;g<=c;g++){f=g*Math.PI/c;k=Math.sin(f);l=Math.cos(f);for(f=0;f<=e;f++)n=2*f*Math.PI/e-Math.PI/2,r=Math.sin(n),n=Math.cos(n),n*=k,m=l,r*=k,s=1-f/e,h=1-g/c,v.push(n*b,m*b,r*b),F.push(n,m,r),y.push(s,h)}for(g=0;g<c;++g)for(f=0;f<e;++f)b=g*(e+1)+f,k=b+e+1,u.push(b+1,k,b),u.push(b+
1,k+1,k);c={normals:F,uvs:y,indices:u};pc.gfx.precalculatedTangents&&(c.tangents=pc.scene.procedural.calculateTangents(v,F,y,u));return pc.scene.procedural.createMesh(d,v,c)};
pc.scene.procedural.createPlane=function(d,a){var b=a&&void 0!==a.halfExtents?a.halfExtents:new pc.Vec2(0.5,0.5),c=a&&void 0!==a.widthSegments?a.widthSegments:5,e=a&&void 0!==a.lengthSegments?a.lengthSegments:5,f,g,k,l,n,r,m=[],s=[],h=[],v=[];for(f=0;f<=c;f++)for(g=0;g<=e;g++)k=-b.x+2*b.x*f/c,l=-(-b.y+2*b.y*g/e),n=f/c,r=g/e,m.push(k,0,l),s.push(0,1,0),h.push(n,r),f<c&&g<e&&(v.push(g+f*(c+1),g+(f+1)*(c+1),g+f*(c+1)+1),v.push(g+(f+1)*(c+1),g+(f+1)*(c+1)+1,g+f*(c+1)+1));b={normals:s,uvs:h,indices:v};
pc.gfx.precalculatedTangents&&(b.tangents=pc.scene.procedural.calculateTangents(m,s,h,v));return pc.scene.procedural.createMesh(d,m,b)};
pc.scene.procedural.createBox=function(d,a){var b=a&&void 0!==a.halfExtents?a.halfExtents:new pc.Vec3(0.5,0.5,0.5),c=a&&void 0!==a.widthSegments?a.widthSegments:1,e=a&&void 0!==a.lengthSegments?a.lengthSegments:1,f=a&&void 0!==a.heightSegments?a.heightSegments:1,g=[new pc.Vec3(-b.x,-b.y,b.z),new pc.Vec3(b.x,-b.y,b.z),new pc.Vec3(b.x,b.y,b.z),new pc.Vec3(-b.x,b.y,b.z),new pc.Vec3(b.x,-b.y,-b.z),new pc.Vec3(-b.x,-b.y,-b.z),new pc.Vec3(-b.x,b.y,-b.z),new pc.Vec3(b.x,b.y,-b.z)],k=[[0,1,3],[4,5,7],[3,
2,6],[1,0,4],[1,4,2],[5,0,6]],l=[[0,0,1],[0,0,-1],[0,1,0],[0,-1,0],[1,0,0],[-1,0,0]],n=[],r=[],m=[],s=[],b=function(a,b,c){var e,d,f,A,z=n.length/3;for(f=0;f<=b;f++)for(A=0;A<=c;A++){e=new pc.Vec3;d=new pc.Vec3;var C=new pc.Vec3,D=new pc.Vec3;e.lerp(g[k[a][0]],g[k[a][1]],f/b);d.lerp(g[k[a][0]],g[k[a][2]],A/c);C.sub2(d,g[k[a][0]]);D.add2(e,C);e=f/b;d=A/c;n.push(D.x,D.y,D.z);r.push(l[a][0],l[a][1],l[a][2]);m.push(e,d);f<b&&A<c&&(s.push(z+A+f*(b+1),z+A+(f+1)*(b+1),z+A+f*(b+1)+1),s.push(z+A+(f+1)*(b+
1),z+A+(f+1)*(b+1)+1,z+A+f*(b+1)+1))}};b(0,c,f);b(1,c,f);b(2,c,e);b(3,c,e);b(4,e,f);b(5,e,f);c={normals:r,uvs:m,indices:s};pc.gfx.precalculatedTangents&&(c.tangents=pc.scene.procedural.calculateTangents(n,r,m,s));return pc.scene.procedural.createMesh(d,n,c)};pc.extend(pc.resources,function(){var d;d=pc.inherits(function(){},pc.resources.ResourceHandler);d.prototype.load=function(a){return new pc.promise.Promise(function(c,e){pc.net.http.get(a.canonical,function(a){c(a)},{error:function(){e()}})})};d.prototype.open=function(a){return a};var a;a=pc.inherits(function(){},pc.resources.ResourceRequest);a.prototype.type="json";a.prototype.Type=Object;return{JsonResourceHandler:d,JsonRequest:a}}());pc.extend(pc.resources,function(){var d;d=pc.inherits(function(){},pc.resources.ResourceHandler);d.prototype.load=function(a){return new RSVP.Promise(function(c,e){pc.net.http.get(a.canonical,function(a){c(a)},{error:function(){e()}})})};d.prototype.open=function(a){return a};var a;a=pc.inherits(function(){},pc.resources.ResourceRequest);a.prototype.type="text";a.prototype.Type=Object;return{TextResourceHandler:d,TextRequest:a}}());pc.extend(pc.resources,function(){var d;d=pc.inherits(function(){},pc.resources.ResourceHandler);d.prototype.load=function(a){return new pc.promise.Promise(function(c,e){var d=new Image;d.onload=function(){c(d)};d.onerror=function(a){e(pc.string.format("Error loading Image from: '{0}'",a.srcElement.src))};d.src=a.canonical})};d.prototype.open=function(a){return a};var a;a=pc.inherits(function(){},pc.resources.ResourceRequest);a.prototype.type="image";a.prototype.Type=Image;return{ImageResourceHandler:d,
ImageRequest:a}}());pc.extend(pc.resources,function(){var d=function(a){this._device=a},d=pc.inherits(d,pc.resources.ResourceHandler);d.prototype.load=function(a,c){var e=a.canonical;return new pc.promise.Promise(function(a,b){var d=pc.path.getExtension(e).toLowerCase();if(".dds"===d||".crn"===d)c=c||{},c.binary=!0,c.directory=pc.path.getDirectory(e),c.crn=".crn"===d,pc.net.http.get(e,function(b){a(b)},{cache:!1});else if(".jpg"===d||".jpeg"===d||".gif"===d||".png"===d){var l=new Image;l.onload=function(){a(l)};l.onerror=
function(a){b(pc.string.format("Error loading Texture from: '{0}'",a.srcElement.src))};l.src=e}})};d.prototype.open=function(a,c,e){var d;if(a instanceof Image)d=c.result?c.result:new pc.gfx.Texture(this._device,{width:a.width,height:a.height,format:pc.gfx.PIXELFORMAT_R8_G8_B8_A8}),d.setSource(a);else if(a instanceof ArrayBuffer){if(e.crn){c=a.byteLength;d=new Uint8Array(a);a=Module._malloc(c);e=Module.HEAPU8;dst32Offset=a/4;for(var g=c%4,k=new Uint32Array(d.buffer,0,(c-g)/4),l=new Uint32Array(e.buffer),
n=0;n<k.length;n++)l[dst32Offset+n]=k[n];for(n=c-g;n<c;n++)e[a+n]=d[n];d=Module._crn_decompress_get_data(a,c);c=Module._crn_decompress_get_size(a,c);a=Module.HEAPU8.buffer.slice(d,d+c)}d=loadDDS(a)}return d};var a;a=pc.inherits(function(){},pc.resources.ResourceRequest);a.prototype.type="texture";a.prototype.Type=pc.gfx.Texture;return{TextureResourceHandler:d,TextureRequest:a}}());pc.extend(pc.resources,function(){var d={points:pc.gfx.PRIMITIVE_POINTS,lines:pc.gfx.PRIMITIVE_LINES,linestrip:pc.gfx.PRIMITIVE_LINESTRIP,triangles:pc.gfx.PRIMITIVE_TRIANGLES,trianglestrip:pc.gfx.PRIMITIVE_TRISTRIP},a={int8:pc.gfx.ELEMENTTYPE_INT8,uint8:pc.gfx.ELEMENTTYPE_UINT8,int16:pc.gfx.ELEMENTTYPE_INT16,uint16:pc.gfx.ELEMENTTYPE_UINT16,int32:pc.gfx.ELEMENTTYPE_INT32,uint32:pc.gfx.ELEMENTTYPE_UINT32,float32:pc.gfx.ELEMENTTYPE_FLOAT32},b=function(a,b){this._device=a;this._assets=b;this._materialLoader=
new pc.resources.MaterialResourceLoader(a,b)},b=pc.inherits(b,pc.resources.ResourceHandler);b.prototype.load=function(a,b){return new pc.promise.Promise(function(c,d){var l=a.canonical;b=b||{};b.directory=pc.path.getDirectory(l);var n=new pc.URI(l);pc.path.getExtension(n.path);pc.net.http.get(l,function(a){c(a)},{cache:b.cache,error:function(a){d(pc.string.format("Error loading model: {0} [{1}]",l,a))}})})};b.prototype.open=function(a,b,c){c=c||{};c.directory=c.directory||"";c.parent=b;var d=null;
1>=a.model.version?logERROR(pc.string.format("Asset: {0}, is an old model format. Upload source assets to re-import.",b.canonical)):2<=a.model.version&&(d=this._loadModelJson(a,b.data,c));return d};b.prototype.clone=function(a){return a.clone()};b.prototype._loadModelJson=function(b,c,g){var k=b.model,l,n,b=[];for(l=0;l<k.nodes.length;l++){var r=k.nodes[l],m=new pc.scene.GraphNode;m.setName(r.name);m.setLocalPosition(r.position[0],r.position[1],r.position[2]);m.setLocalEulerAngles(r.rotation[0],r.rotation[1],
r.rotation[2]);m.setLocalScale(r.scale[0],r.scale[1],r.scale[2]);b.push(m)}for(l=1;l<k.parents.length;l++)b[k.parents[l]].addChild(b[l]);0<k.skins.length&&(l=this._device.getBoneLimit(),pc.scene.partitionSkin(k,c,l));var s=[],r=[];for(l=0;l<k.skins.length;l++){var h=k.skins[l],m=[];for(n=0;n<h.inverseBindMatrices.length;n++){var v=h.inverseBindMatrices[n];m[n]=new pc.Mat4(v[0],v[1],v[2],v[3],v[4],v[5],v[6],v[7],v[8],v[9],v[10],v[11],v[12],v[13],v[14],v[15])}h=new pc.scene.Skin(m,h.boneNames);s.push(h);
m=new pc.scene.SkinInstance(h);v=[];for(n=0;n<h.boneNames.length;n++){var F=b[0].findByName(h.boneNames[n]);v.push(F)}m.bones=v;r.push(m)}var h=[],y,m={position:pc.gfx.SEMANTIC_POSITION,normal:pc.gfx.SEMANTIC_NORMAL,tangent:pc.gfx.SEMANTIC_TANGENT,blendWeight:pc.gfx.SEMANTIC_BLENDWEIGHT,blendIndices:pc.gfx.SEMANTIC_BLENDINDICES,color:pc.gfx.SEMANTIC_COLOR,texCoord0:pc.gfx.SEMANTIC_TEXCOORD0,texCoord1:pc.gfx.SEMANTIC_TEXCOORD1,texCoord2:pc.gfx.SEMANTIC_TEXCOORD2,texCoord3:pc.gfx.SEMANTIC_TEXCOORD3,
texCoord4:pc.gfx.SEMANTIC_TEXCOORD4,texCoord5:pc.gfx.SEMANTIC_TEXCOORD5,texCoord6:pc.gfx.SEMANTIC_TEXCOORD6,texCoord7:pc.gfx.SEMANTIC_TEXCOORD7};for(l=0;l<k.vertices.length;l++){v=k.vertices[l];if(v.position&&v.normal&&v.texCoord0){F=[];for(n=0;n<k.meshes.length;n++)k.meshes[n].vertices===l&&(F=F.concat(k.meshes[n].indices));tangents=pc.scene.procedural.calculateTangents(v.position.data,v.normal.data,v.texCoord0.data,F);v.tangent={type:"float32",components:4,data:tangents}}n=[];for(y in v){var F=
v[y],u=F.type;this._device.supportsUnsignedByte||("uint8"===u&&(u="float32"),"int8"===u&&(u="float32"));n.push({semantic:m[y],components:F.components,type:a[u],normalize:!1})}n=new pc.gfx.VertexFormat(this._device,n);var u=v.position.data.length/v.position.components,w=new pc.gfx.VertexBuffer(this._device,n,u),A=new pc.gfx.VertexIterator(w);for(n=0;n<u;n++){for(y in v)switch(F=v[y],F.components){case 1:A.element[m[y]].set(F.data[n]);break;case 2:A.element[m[y]].set(F.data[2*n],F.data[2*n+1]);break;
case 3:A.element[m[y]].set(F.data[3*n],F.data[3*n+1],F.data[3*n+2]);break;case 4:A.element[m[y]].set(F.data[4*n],F.data[4*n+1],F.data[4*n+2],F.data[4*n+3])}A.next()}A.end();h.push(w)}for(l=m=0;l<k.meshes.length;l++)v=k.meshes[l],"undefined"!==typeof v.indices&&(m+=v.indices.length);u=F=null;w=0;0<m&&(F=new pc.gfx.IndexBuffer(this._device,pc.gfx.INDEXFORMAT_UINT16,m),u=new Uint16Array(F.lock()));y=[];for(l=0;l<k.meshes.length;l++){v=k.meshes[l];n=v.aabb.min;var A=v.aabb.max,A=new pc.shape.Aabb(new pc.Vec3(0.5*
(A[0]+n[0]),0.5*(A[1]+n[1]),0.5*(A[2]+n[2])),new pc.Vec3(0.5*(A[0]-n[0]),0.5*(A[1]-n[1]),0.5*(A[2]-n[2]))),z="undefined"!==typeof v.indices;n=new pc.scene.Mesh;n.vertexBuffer=h[v.vertices];n.indexBuffer[0]=z?F:null;n.primitive[0].type=d[v.type];n.primitive[0].base=z?v.base+w:v.base;n.primitive[0].count=v.count;n.primitive[0].indexed=z;n.skin="undefined"!==typeof v.skin?s[v.skin]:null;n.aabb=A;z&&(u.set(v.indices,w),w+=v.indices.length);y.push(n)}0<m&&F.unlock();h=[];v=new pc.scene.PhongMaterial;for(l=
0;l<k.meshInstances.length;l++){n=k.meshInstances[l];m=b[n.node];n=y[n.mesh];(F=this._getMaterial(l,c,g))||(F=v);m=new pc.scene.MeshInstance(m,n,F);if(n.skin){n=s.indexOf(n.skin);if(-1===n)throw Error("Mesh's skin does not appear in skin array.");m.skinInstance=r[n]}h.push(m)}c=new pc.scene.Model;c.graph=b[0];c.meshInstances=h;c.skinInstances=r;c.getGraph().syncHierarchy();h=c.meshInstances;for(l=0;l<h.length;l++)h[l].syncAabb();return c};b.prototype._getMaterial=function(a,b,c){var d;if(b&&b.length>
a)if(b[a].material)d=this._materialLoader.load(b[a].material);else if(b[a].path&&(c=pc.path.split(c.parent.canonical)[0],c=pc.path.join(c,b[a].path),a=this._assets.getAssetByUrl(c)))d=a.resource;return d};var c;c=pc.inherits(function(){},pc.resources.ResourceRequest);c.prototype.type="model";c.prototype.Type=pc.scene.Model;return{ModelResourceHandler:b,ModelRequest:c}}());pc.extend(pc.resources,function(){var d={repeat:pc.gfx.ADDRESS_REPEAT,clamp:pc.gfx.ADDRESS_CLAMP_TO_EDGE,mirror:pc.gfx.ADDRESS_MIRRORED_REPEAT},a={nearest:pc.gfx.FILTER_NEAREST,linear:pc.gfx.FILTER_LINEAR,nearest_mip_nearest:pc.gfx.FILTER_NEAREST_MIPMAP_NEAREST,linear_mip_nearest:pc.gfx.FILTER_LINEAR_MIPMAP_NEAREST,nearest_mip_linear:pc.gfx.FILTER_NEAREST_MIPMAP_LINEAR,linear_mip_linear:pc.gfx.FILTER_LINEAR_MIPMAP_LINEAR},b={},c=function(a,b){this._device=a;this._assets=b};c.prototype.load=function(a){if(!b[a]){var c=
this._assets.getAssetByResourceId(a);c||(c=this._assets.find(a));if(c){var e=new pc.scene.PhongMaterial;this._updatePhongMaterial(e,c.data);c.on("change",function(a,b,c){"data"===b&&this._updatePhongMaterial(e,c)},this);b[a]=e}}return b[a]};c.prototype._updatePhongMaterial=function(a,b){for(var c=0;c<b.parameters.length;c++){var e=b.parameters[c];"texture"===e.type&&(e.data&&!(e.data instanceof pc.gfx.Texture))&&(e.data=this._loadTexture(e.data))}a.init(b)};c.prototype._loadTexture=function(b){b=
this._assets.getAssetByResourceId(b);if(!b)return null;var c=b.getFileUrl();if(!c)return null;var e=b.data,c=this._assets.loader.getFromCache(c);c||(c=new pc.gfx.Texture(this._device,{format:pc.gfx.PIXELFORMAT_R8_G8_B8_A8}),c.name=e.name,c.addressU=d[e.addressu],c.addressV=d[e.addressv],c.magFilter=a[e.magfilter],c.minFilter=a[e.minfilter]);this._assets.load([b],[c],{});return c};var e=function(a){this._assets=a},e=pc.inherits(e,pc.resources.ResourceHandler);e.prototype.load=function(a){return new pc.promise.Promise(function(b,
c){pc.net.http.get(a.canonical,function(c){if("path"===c.mapping_format){var e=this._listTextures(c),d=[];e.length?(e.forEach(function(b){var c=pc.path.getBasename(b),b=pc.path.join(pc.path.split(a.canonical)[0],b);d.push(new pc.asset.Asset(c,"texture",{url:b}))}),this._assets.load(d).then(function(){b(c)})):b(c)}else b(c)}.bind(this),{error:function(){c()}})}.bind(this))};e.prototype.open=function(a,b){var c=new pc.scene.PhongMaterial;this._updatePhongMaterial(c,a,b);return c};e.prototype._listTextures=
function(a){var b,c=a.parameters.length,e,d=[];for(b=0;b<c;b++)e=a.parameters[b],"texture"===e.type&&e.data&&d.push(e.data);return d};e.prototype._updatePhongMaterial=function(a,b,c){for(var e=0;e<b.parameters.length;e++){var d=b.parameters[e];"texture"===d.type&&(d.data&&!(d.data instanceof pc.gfx.Texture))&&(d.data=this._loadTexture(d.data,c))}a.init(b)};e.prototype._loadTexture=function(b,c){var e=this._assets.getAssetByResourceId(b);if(!e)var f=pc.path.join(pc.path.split(c.canonical)[0],b),e=
this._assets.getAssetByUrl(f);if(!e)return null;if(e.resource)return e.resource;f=e.getFileUrl();if(!f)return null;var r=e.data,f=this._assets.loader.getFromCache(f);f||(f=new pc.gfx.Texture(this._device,{format:pc.gfx.PIXELFORMAT_R8_G8_B8_A8}),f.name=r.name,f.addressU=d[r.addressu],f.addressV=d[r.addressv],f.magFilter=a[r.magfilter],f.minFilter=a[r.minfilter]);this._assets.load([e],[f],{});return f};var f;f=pc.inherits(function(){},pc.resources.ResourceRequest);f.prototype.type="material";f.prototype.Type=
pc.scene.Material;return{MaterialResourceLoader:c,MaterialRequest:f,MaterialResourceHandler:e}}());pc.anim={};pc.anim.Key=function(d,a,b,c){this.time=d;this.position=a;this.rotation=b;this.scale=c};pc.anim.Node=function(){this._name="";this._keys=[]};
...
this._time=0;this.looping=!0;this._interpolatedKeys=[];this._interpolatedKeyDict={};this._currKeyIndices={};this.graph=null;var e=this;c(a)};a.prototype.addTime=function(a){if(null!==this._animation&&(this._time!==n||this.looping)){var c,e,d,g,k,l=this._animation.getNodes();this._time+=a;var n=this._animation.getDuration();if(this._time>n){this._time=this.looping?0:n;for(a=0;a<l.length;a++)c=l[a],n=c._name,this._currKeyIndices[n]=0}for(a=0;a<l.length;a++)if(c=l[a],n=c._name,c=c._keys,e=this._interpolatedKeyDict[n],
1===c.length)e._pos.copy(c[0].position),e._quat.copy(c[0].rotation),e._scale(c[0].scale);else for(var r=this._currKeyIndices[n];r<c.length-1;r++)d=c[r],g=c[r+1],d.time<=this._time&&g.time>=this._time&&(k=(this._time-d.time)/(g.time-d.time),e._pos.lerp(d.position,g.position,k),e._quat.slerp(d.rotation,g.rotation,k),e._scale.lerp(d.scale,g.scale,k),e._written=!0,this._currKeyIndices[n]=r)}};a.prototype.blend=function(a,c,e){for(var d=this._interpolatedKeys.length,g=0;g<d;g++){var k=a._interpolatedKeys[g],
l=c._interpolatedKeys[g],n=this._interpolatedKeys[g];k._written&&l._written?(n._quat.slerp(k._quat,c._interpolatedKeys[g]._quat,e),n._pos.lerp(k._pos,c._interpolatedKeys[g]._pos,e),n._scale.lerp(k._scale,l._scale,e),n._written=!0):k._written?(n._quat.copy(k._quat),n._pos.copy(k._pos),n._scale.copy(k._scale),n._written=!0):l._written&&(n._quat.copy(l._quat),n._pos.copy(l._pos),n._scale.copy(l._scale),n._written=!0)}};a.prototype.getAnimation=function(){return this._animation};a.prototype.getCurrentTime=
...
return{Skeleton:a}}());pc.extend(pc.resources,function(){var d;d=pc.inherits(function(){},pc.resources.ResourceHandler);d.prototype.load=function(a,c){return new pc.promise.Promise(function(e,d){var g=a.canonical;pc.path.getDirectory(g);pc.net.http.get(g,function(a){try{e(a)}catch(b){d(pc.string.format("An error occured while loading animation from: '{0}'",g))}}.bind(this),{cache:c.cache,error:function(a){d(a)}})})};d.prototype.open=function(a){return this["_loadAnimationV"+a.animation.version](a)};d.prototype._loadAnimationV3=
function(a){var a=a.animation,c=new pc.anim.Animation;c.setName(a.name);c.setDuration(a.duration);for(var e=0;e<a.nodes.length;e++){var d=new pc.anim.Node,g=a.nodes[e];d._name=g.name;for(var k=0;k<g.keys.length;k++){var l=g.keys[k],n=l.time,r=l.pos,m=l.rot,l=l.scale,r=new pc.Vec3(r[0],r[1],r[2]),m=(new pc.Quat).setFromEulerAngles(m[0],m[1],m[2]),l=new pc.Vec3(l[0],l[1],l[2]),n=new pc.anim.Key(n,r,m,l);d._keys.push(n)}c.addNode(d)}return c};d.prototype._loadAnimationV4=function(a){var a=a.animation,
c=new pc.anim.Animation;c.setName(a.name);c.setDuration(a.duration);for(var e=0;e<a.nodes.length;e++){var d=new pc.anim.Node,g=a.nodes[e];d._name=g.name;for(var k=g.defaults.p,l=g.defaults.r,n=g.defaults.s,r=0;r<g.keys.length;r++){var m=g.keys[r],s=m.t,h=k?k:m.p,v=l?l:m.r,m=n?n:m.s,h=new pc.Vec3(h[0],h[1],h[2]),v=(new pc.Quat).setFromEulerAngles(v[0],v[1],v[2]),m=new pc.Vec3(m[0],m[1],m[2]),s=new pc.anim.Key(s,h,v,m);d._keys.push(s)}c.addNode(d)}return c};var a;a=pc.inherits(function(){},pc.resources.ResourceRequest);
...
axes:["PAD_L_STICK_X","PAD_L_STICK_Y","PAD_R_STICK_X","PAD_R_STICK_Y"]}},b={"Product: 0268":"PS3"};d.prototype={update:function(){var a=this.poll(),b,d=a.length;for(b=0;b<d;b++)this.previous[b]=this.current[b],this.current[b]=a[b]},poll:function(){var a=[];if(this.gamepadsSupported){var b=navigator.webkitGetGamepads(),d,g=b.length;for(d=0;d<g;d++)b[d]&&a.push({map:this.getMap(b[d]),pad:b[d]})}return a},getMap:function(c){for(var e in b)if(0<=c.id.indexOf(e))return a[b[e]];return a.DEFAULT},isPressed:function(a,
...
PAD_FACE_3:2,PAD_FACE_4:3,PAD_L_SHOULDER_1:4,PAD_R_SHOULDER_1:5,PAD_L_SHOULDER_2:6,PAD_R_SHOULDER_2:7,PAD_SELECT:8,PAD_START:9,PAD_L_STICK_BUTTON:10,PAD_R_STICK_BUTTON:11,PAD_UP:12,PAD_DOWN:13,PAD_LEFT:14,PAD_RIGHT:15,PAD_VENDOR:16,PAD_L_STICK_X:0,PAD_L_STICK_Y:1,PAD_R_STICK_X:2,PAD_R_STICK_Y:3,GamePads:d}}());pc.extend(pc.input,function(){var d=function(b,e){this.element=e.target;this.event=e;this.touches=[];this.changedTouches=[];if(e){var d,g=e.touches.length;for(d=0;d<g;d++)this.touches.push(new a(e.touches[d]));g=e.changedTouches.length;for(d=0;d<g;d++)this.changedTouches.push(new a(e.changedTouches[d]))}};d.prototype={getTouchById:function(a,b){var d,g=b.length;for(d=0;d<g;d++)if(b[d].id===a)return b[d];return null}};var a=function(a){var b=pc.input.getTouchTargetCoords(a);this.id=a.identifier;this.x=
...
binaryExtensions:d.binaryExtensions,get:function(a,b,c,e){c=c||{};c.success=b;return this.request("GET",a,c,e)},post:function(a,b,c,e,d){e=e||{};e.success=b;e.postdata=c;return this.request("POST",a,e,d)},put:function(a,b,c,e,d){e=e||{};e.success=b;e.postdata=c;return this.request("PUT",a,e,d)},del:function(a,b,c,e){c=c||{};c.success=b;return this.request("DELETE",a,c,e)},request:function(a,b,c,e){var f,g,k,l=!1,c=c||{};null==c.success&&(c.success=function(){});null==c.error&&(c.error=function(){});
null==c.async&&(c.async=!0);null==c.headers&&(c.headers={});if(null!=c.postdata)if(c.postdata instanceof Document)k=c.postdata;else if(c.postdata instanceof FormData)k=c.postdata;else if(c.postdata instanceof Object)switch(k=c.headers["Content-Type"],pc.isDefined(k)||(c.headers["Content-Type"]=d.ContentType.FORM_URLENCODED,k=c.headers["Content-Type"]),k){case d.ContentType.FORM_URLENCODED:k="";g=!0;for(f in c.postdata)c.postdata.hasOwnProperty(f)&&(g?g=!1:k+="&",k+=escape(f)+"="+escape(c.postdata[f]));
break;default:null==k&&(c.headers["Content-Type"]=d.ContentType.JSON),k=JSON.stringify(c.postdata)}else k=c.postdata;e||(e=new XMLHttpRequest);!1===c.cache&&(g=pc.time.now(),f=new pc.URI(b),f.query=f.query?f.query+"&ts="+g:"ts="+g,b=f.toString());c.query&&(f=new pc.URI(b),g=pc.extend(f.getQuery(),c.query),f.setQuery(g),b=f.toString());e.open(a,b,c.async);e.withCredentials=!0;e.responseType=c.responseType||this.guessResponseType(b);for(var n in c.headers)c.headers.hasOwnProperty(n)&&e.setRequestHeader(n,
...
"ts="+timestamp;return a=uri.toString()};d.prototype._onScriptCreated=function(a,c){this._pending.push({name:a,callback:c})};d.prototype._addScriptTag=function(a,c,e){var d=this,g=document.getElementsByTagName("head")[0],k=document.createElement("script");this._loading=k;k.addEventListener("error",function(a){e(pc.string.format("Error loading script from '{0}'",a.target.src))});var l=!1;k.onload=k.onreadystatechange=function(){if(!l&&(!this.readyState||"loaded"==this.readyState||"complete"==this.readyState)){l=
!0;var e=d._pending.shift();if(e){var g=e.callback(d._context);if(g._pcScriptName)throw Error("Attribute _pcScriptName is reserved on ScriptTypes for ResourceLoader use");g._pcScriptName=e.name;d._loaded[a]=g;c(g)}else d._loaded[a]=!0,c(null);d._loading=null;d._queue.length&&(e=d._queue.shift(),d._addScriptTag(e.url,e.success,e.error))}};k.src=a;g.appendChild(k)};var a;a=pc.inherits(function(){},pc.resources.ResourceRequest);a.prototype.type="script";return{ScriptResourceHandler:d,ScriptRequest:a}}());pc.fw={};var editor=editor||{};pc.extend(editor,function(){var d=function(){this.exposed={};this.added={};this.scripts={};this.systems=[]};d.prototype={addComponentType:function(){},expose:function(){},add:function(){},scriptexpose:function(){}};return{LinkInterface:d,link:new d}}());pc.extend(editor,function(){var d=function(){this.exposed={};this.added={};this.scripts={};this.systems=[]};d.prototype.addComponentType=function(a){var b=a.id,c,e=this.systems,d=e.length,g=!1;for(c=0;c<d;c++)if(e[c].name===b){g=!0;break}g||this.systems.push({name:b,description:a.description});this.exposed[b]||(this.exposed[b]={})};d.prototype.expose=function(a,b){if(!b.name)throw Error("Missing option 'name'");b.options=b.options||{};if("vector"===b.type)if(b.array=!0,b.defaultValue)switch(b.defaultValue.length){case 2:b.RuntimeType=
pc.Vec2;break;case 3:b.RuntimeType=pc.Vec3;break;case 4:b.RuntimeType=pc.Vec4}else b.RuntimeType=pc.Vec3;if("rgb"===b.type||"rgba"===b.type)b.array=!0,b.RuntimeType=pc.Color;this.exposed[a][b.name]||(this.exposed[a][b.name]={});this.exposed[a][b.name]=b};d.prototype.add=function(a){logASSERT(a.system,"Missing option: 'system'");logASSERT(a.variable,"Missing option: 'variable'");this.added[a.system]||(this.added[a.system]={});this.added[a.system][a.variable]||(this.added[a.system][a.variable]={});
this.added[a.system][a.variable]=a};d.prototype.scriptexpose=function(a){this.scripts[a.script]=a};return{LinkInterface:d,link:new d}}());pc.extend(pc.fw,function(){return{ContentFile:function(d){this.packs=d.packs||{};this.appProperties=d.application_properties||{};this.toc=d.toc||{}}}}());pc.extend(pc.fw,function(){var d=function(a){this.hierarchy=a.hierarchy;this.settings=a.settings};d.prototype={};return{Pack:d}}());pc.extend(pc.fw,function(){return{ApplicationContext:function(d,a,b,c,e){this.loader=d;this.scene=a;this.graphicsDevice=b;this.root=new pc.fw.Entity;d=e.depot?e.depot.assets.getServer().getBaseUrl():null;this.assets=new pc.asset.AssetRegistry(this.loader,d);this.systems=c;e=e||{};this.controller=e.controller;this.keyboard=e.keyboard;this.mouse=e.mouse;this.touch=e.touch;this.gamepads=e.gamepads}}}());pc.extend(pc.fw,function(){var d,a=function(b,c){c=c||{};this._inTools=!1;pc.events.attach(this);this.content=c.content;this.canvas=b;this.fillMode=pc.fw.FillMode.KEEP_ASPECT;this.resolutionMode=pc.fw.ResolutionMode.FIXED;this.librariesLoaded=!1;this._link=new pc.fw.LiveLink("application");this._link.addDestinationWindow(window);this._link.listen(this._handleMessage.bind(this));pc.log.open();this.graphicsDevice=new pc.gfx.Device(b);this.graphicsDevice.enableValidation(!1);var e=new pc.fw.ComponentSystemRegistry;
this.audioManager=new pc.audio.AudioManager;var d=new pc.resources.ResourceLoader;!1===c.cache&&(d.cache=!1);c.displayLoader&&new pc.resources.ResourceLoaderDisplay(document.body,d);this.context=new pc.fw.ApplicationContext(d,new pc.scene.Scene,this.graphicsDevice,e,c);new pc.resources.TextureCache(d);d.registerHandler(pc.resources.JsonRequest,new pc.resources.JsonResourceHandler);d.registerHandler(pc.resources.TextRequest,new pc.resources.TextResourceHandler);d.registerHandler(pc.resources.ImageRequest,
new pc.resources.ImageResourceHandler);d.registerHandler(pc.resources.MaterialRequest,new pc.resources.MaterialResourceHandler(this.context.assets));d.registerHandler(pc.resources.TextureRequest,new pc.resources.TextureResourceHandler(this.graphicsDevice));d.registerHandler(pc.resources.ModelRequest,new pc.resources.ModelResourceHandler(this.graphicsDevice,this.context.assets));d.registerHandler(pc.resources.AnimationRequest,new pc.resources.AnimationResourceHandler);d.registerHandler(pc.resources.PackRequest,
new pc.resources.PackResourceHandler(e,c.depot));d.registerHandler(pc.resources.AudioRequest,new pc.resources.AudioResourceHandler(this.audioManager));this.renderer=new pc.scene.ForwardRenderer(this.graphicsDevice);d.registerHandler(pc.resources.ScriptRequest,new pc.resources.ScriptResourceHandler(this.context,c.scriptPrefix));new pc.fw.RigidBodyComponentSystem(this.context);new pc.fw.CollisionComponentSystem(this.context);new pc.fw.BallSocketJointComponentSystem(this.context);new pc.fw.AnimationComponentSystem(this.context);
new pc.fw.ModelComponentSystem(this.context);new pc.fw.CameraComponentSystem(this.context);new pc.fw.CubeMapComponentSystem(this.context);new pc.fw.StaticCubeMapComponentSystem(this.context);new pc.fw.LightComponentSystem(this.context);new pc.fw.PackComponentSystem(this.context);new pc.fw.SkyboxComponentSystem(this.context);new pc.fw.ScriptComponentSystem(this.context);new pc.fw.PickComponentSystem(this.context);new pc.fw.AudioSourceComponentSystem(this.context,this.audioManager);new pc.fw.AudioListenerComponentSystem(this.context,
this.audioManager);new pc.fw.DesignerComponentSystem(this.context);this.on("librariesloaded",this.onLibrariesLoaded,this);c.libraries&&c.libraries.length?(e=c.libraries.map(function(a){return new pc.resources.ScriptRequest(a)}),d.request(e).then(function(){this.fire("librariesloaded",this);this.librariesLoaded=!0}.bind(this))):(this.fire("librariesloaded",this),this.librariesLoaded=!0);"undefined"!==typeof document.hidden?(this._hiddenAttr="hidden",document.addEventListener("visibilitychange",this.onVisibilityChange.bind(this),
!1)):"undefined"!==typeof document.mozHidden?(this._hiddenAttr="mozHidden",document.addEventListener("mozvisibilitychange",this.onVisibilityChange.bind(this),!1)):"undefined"!==typeof document.msHidden?(this._hiddenAttr="msHidden",document.addEventListener("msvisibilitychange",this.onVisibilityChange.bind(this),!1)):"undefined"!==typeof document.webkitHidden&&(this._hiddenAttr="webkitHidden",document.addEventListener("webkitvisibilitychange",this.onVisibilityChange.bind(this),!1));a._applications[this.canvas.id]=
this};a._applications={};a.getApplication=function(b){return a._applications[b]};a.prototype={loadFromToc:function(a,c,e,d){this.content||e("No content");var g=this.content.toc[a],c=c||function(){},e=e||function(){},d=d||function(){};this.context.assets.update(g);var k=function(){guid=g.packs[0];this.context.loader.request(new pc.resources.PackRequest(guid)).then(function(a){a=a[0];this.context.root.addChild(a.hierarchy);pc.fw.ComponentSystem.initialize(a.hierarchy);pc.fw.ComponentSystem.postInitialize(a.hierarchy);
if(this.context.systems.rigidbody&&"undefined"!==typeof Ammo){var b=a.settings.physics.gravity;this.context.systems.rigidbody.setGravity(b[0],b[1],b[2])}b=a.settings.render.global_ambient;this.context.scene.ambientLight=new pc.Color(b[0],b[1],b[2]);this.context.scene.fog=a.settings.render.fog;b=a.settings.render.fog_color;this.context.scene.fogColor=new pc.Color(b[0],b[1],b[2]);this.context.scene.fogStart=a.settings.render.fog_start;this.context.scene.fogEnd=a.settings.render.fog_end;this.context.scene.fogDensity=
a.settings.render.fog_density;this.context.scene.shadowDistance=a.settings.render.shadow_distance;c(a);this.context.loader.off("progress",d)}.bind(this),function(a){e(a)}).then(null,function(a){setTimeout(function(){throw a;},0)})}.bind(this),l=function(){var a=this.context.assets.all();this.context.loader.on("progress",d);a.length?this.context.assets.load(a).then(function(a){k(a)}):setTimeout(function(){k([])},0)}.bind(this);if(this.librariesLoaded)l();else this.on("librariesloaded",function(){l()})},
start:function(){if(this.librariesLoaded)this.tick();else this.on("librariesloaded",function(){this.tick()},this)},update:function(a){var c=this.context;pc.fw.ComponentSystem.fixedUpdate(1/60,c,this._inTools);pc.fw.ComponentSystem.update(a,c,this._inTools);pc.fw.ComponentSystem.postUpdate(a,c,this._inTools);this.fire("update",a);c.controller&&c.controller.update(a);c.mouse&&c.mouse.update(a);c.keyboard&&c.keyboard.update(a);c.gamepads&&c.gamepads.update(a)},render:function(){var a=this.context,c=
a.systems.camera.cameras,e=null,d=this.renderer;a.root.syncHierarchy();for(var g=0,k=c.length;g<k;g++)e=c[g],e.frameBegin(),d.render(a.scene,e.camera),e.frameEnd()},tick:function(){requestAnimationFrame(this.tick.bind(this),this.canvas);var a=window.performance&&window.performance.now?performance.now():Date.now(),c=(a-(d||a))/1E3;d=a;c=pc.math.clamp(c,0,0.1);this.update(c);this.render()},setCanvasFillMode:function(a,c,e){this.fillMode=a;this.resizeCanvas(c,e)},setCanvasResolution:function(a,c,e){this.resolutionMode=
a;a===pc.fw.ResolutionMode.AUTO&&void 0===c&&(c=this.canvas.clientWidth,e=this.canvas.clientHeight);this.graphicsDevice.resizeCanvas(c,e)},isFullscreen:function(){return!!document.fullscreenElement},enableFullscreen:function(a,c,e){var a=a||this.canvas,d=function(){c();document.removeEventListener("fullscreenchange",d)},g=function(){e();document.removeEventListener("fullscreenerror",g)};c&&document.addEventListener("fullscreenchange",d,!1);e&&document.addEventListener("fullscreenerror",g,!1);a.requestFullscreen()},
disableFullscreen:function(a){var c=function(){a();document.removeEventListener("fullscreenchange",c)};a&&document.addEventListener("fullscreenchange",c,!1);document.exitFullscreen()},isHidden:function(){return document[this._hiddenAttr]},onVisibilityChange:function(){this.isHidden()?this.audioManager.suspend():this.audioManager.resume()},resizeCanvas:function(a,c){var e=window.innerWidth,d=window.innerHeight;if(navigator.isCocoonJS)a=e,c=d,e=window.devicePixelRatio,this.graphicsDevice.resizeCanvas(a*
e,c*e);else{if(this.fillMode===pc.fw.FillMode.KEEP_ASPECT){var g=this.canvas.width/this.canvas.height;g>e/d?(a=e,c=a/g):(c=d,a=c*g)}else this.fillMode===pc.fw.FillMode.FILL_WINDOW&&(a=e,c=d);this.canvas.style.width=a+"px";this.canvas.style.height=c+"px";this.resolutionMode===pc.fw.ResolutionMode.AUTO&&this.setCanvasResolution(pc.fw.ResolutionMode.AUTO)}return{width:a,height:c}},onLibrariesLoaded:function(){this.context.systems.rigidbody.onLibraryLoaded();this.context.systems.collision.onLibraryLoaded()},
_handleMessage:function(a){var c;switch(a.type){case pc.fw.LiveLinkMessageType.UPDATE_COMPONENT:this._linkUpdateComponent(a.content.id,a.content.component,a.content.attribute,a.content.value);break;case pc.fw.LiveLinkMessageType.UPDATE_ENTITY:this._linkUpdateEntity(a.content.id,a.content.components);break;case pc.fw.LiveLinkMessageType.UPDATE_ENTITY_TRANSFORM:this._linkUpdateEntityTransform(a.content.id,a.content.position,a.content.rotation,a.content.scale);break;case pc.fw.LiveLinkMessageType.UPDATE_ENTITY_NAME:c=
this.context.root.findOne("getGuid",a.content.id);c.setName(a.content.name);break;case pc.fw.LiveLinkMessageType.UPDATE_ENTITY_ENABLED:c=this.context.root.findOne("getGuid",a.content.id);c.enabled=a.content.enabled;break;case pc.fw.LiveLinkMessageType.REPARENT_ENTITY:this._linkReparentEntity(a.content.id,a.content.newParentId,a.content.index);break;case pc.fw.LiveLinkMessageType.CLOSE_ENTITY:if(c=this.context.root.findOne("getGuid",a.content.id))logDEBUG(pc.string.format("RT: Removed '{0}' from parent {1}",
a.content.id,c.getParent().getGuid())),c.destroy();break;case pc.fw.LiveLinkMessageType.OPEN_PACK:c=this.context.loader.open(pc.resources.PackRequest,a.content.pack);c=c.hierarchy;c.__parent?(a=this.context.root.findByGuid(c.__parent),a.addChild(c)):this.context.root.addChild(c);break;case pc.fw.LiveLinkMessageType.OPEN_ENTITY:a.content.entity&&(c={application_data:{},hierarchy:a.content.entity},c=this.context.loader.open(pc.resources.PackRequest,c),c=c.hierarchy,c.__parent?(a=this.context.root.findByGuid(c.__parent),
a.addChild(c)):this.context.root.addChild(c));break;case pc.fw.LiveLinkMessageType.UPDATE_ASSET:this._linkUpdateAsset(a.content.id,a.content.attribute,a.content.value);break;case pc.fw.LiveLinkMessageType.UPDATE_ASSETCACHE:this.context.assets.update(a.content,this.context.loader);break;case pc.fw.LiveLinkMessageType.UPDATE_PACK_SETTINGS:this._linkUpdatePackSettings(a.content.settings)}},_linkUpdateComponent:function(a,c,e,d){var a=this.context.root.findOne("getGuid",a),g;a&&(c?a[c]?(g=editor.link.exposed[c][e],
a[c][e]=editor&&g?g.RuntimeType?g.RuntimeType===pc.Vec3?new g.RuntimeType(d[0],d[1],d[2]):g.RuntimeType===pc.Vec4?new g.RuntimeType(d[0],d[1],d[2],d[3]):g.RuntimeType===pc.Vec2?new g.RuntimeType(d[0],d[1]):g.RuntimeType===pc.Color?3===d.length?new g.RuntimeType(d[0],d[1],d[2]):new g.RuntimeType(d[0],d[1],d[2],d[3]):new g.RuntimeType(d):d:d):logWARNING(pc.string.format("No component system called '{0}' exists",c)):a[e]=d)},_linkUpdateEntityTransform:function(a,c,e,d){if(a=this.context.root.findByGuid(a))a.setLocalPosition(c[0],
c[1],c[2]),a.setLocalEulerAngles(e[0],e[1],e[2]),a.setLocalScale(d[0],d[1],d[2]),a.fire("livelink:updatetransform",c,e,d)},_linkReparentEntity:function(a,c){var e=this.context.root.findByGuid(a),d=this.context.root.findByGuid(c);e.reparent(d)},_linkUpdateEntity:function(a,c){var e,d=this.context.root.findOne("getGuid",a);if(d){var g=this.context.systems.getComponentSystemOrder(),k,l=g.length;for(k=0;k<l;k++)e=g[k],c.hasOwnProperty(e)&&this.context.systems.hasOwnProperty(e)&&(d[e]||this.context.systems[e].addComponent(d,
{}));for(e in this.context.systems)"gizmo"===e||"pick"===e||this.context.systems.hasOwnProperty(e)&&!c.hasOwnProperty(e)&&d[e]&&this.context.systems[e].removeComponent(d)}},_linkUpdateAsset:function(a,c,e){if(a=this.context.assets.getAssetByResourceId(a))a[c]=e,a.fire("change",a,c,e)},_linkUpdatePackSettings:function(a){var c=a.render.global_ambient;this.context.scene.ambientLight.set(c[0],c[1],c[2]);this.context.systems.rigidbody&&"undefined"!==typeof Ammo&&(c=a.physics.gravity,this.context.systems.rigidbody.setGravity(c[0],
c[1],c[2]));this.context.scene.fog=a.render.fog;this.context.scene.fogStart=a.render.fog_start;this.context.scene.fogEnd=a.render.fog_end;c=a.render.fog_color;this.context.scene.fogColor=new pc.Color(c[0],c[1],c[2]);this.context.scene.fogDensity=a.render.fog_density;this.context.scene.shadowDistance=a.render.shadow_distance}};return{FillMode:{NONE:"NONE",FILL_WINDOW:"FILL_WINDOW",KEEP_ASPECT:"KEEP_ASPECT"},ResolutionMode:{AUTO:"AUTO",FIXED:"FIXED"},Application:a}}());pc.extend(pc.resources,function(){var d=function(a,c){this._registry=a;this._depot=c},d=pc.inherits(d,pc.resources.ResourceHandler);d.prototype.load=function(a){return new pc.promise.Promise(function(c,e){var d=a.canonical;d in pc.content.packs?setTimeout(function(){c(pc.content.packs[d])},0):this._depot.packs.getOne(d,function(a){c(a)}.bind(this),function(a){e(a)})}.bind(this))};d.prototype.open=function(a,c){return this.openPack(a,c)};d.prototype.openPack=function(a,c){var e=pc.extend({},a);e.hierarchy=
this.openEntity(e.hierarchy,c);return new pc.fw.Pack(e)};d.prototype.openEntity=function(a,c){var e;e=this.openEntityHierarchy(a,c);e.syncHierarchy();return e=this.openComponentData(e,a,c)};d.prototype.openEntityHierarchy=function(a,c){var e=new pc.fw.Entity,d=a.position,g=a.rotation,k=a.scale;e.setName(a.name);e.setGuid(a.resource_id);e.setLocalPosition(d[0],d[1],d[2]);e.setLocalEulerAngles(g[0],g[1],g[2]);e.setLocalScale(k[0],k[1],k[2]);e._enabled=void 0!==a.enabled?a.enabled:!0;e._enabledInHierarchy=
e._enabled;a.labels&&a.labels.forEach(function(a){e.addLabel(a)});e.__parent=a.parent;e.__children=a.children;e.name=a.name;e.template=a.template;k=a.children.length;for(d=0;d<k;d++)g=this.openEntityHierarchy(a.children[d],c),e.addChild(g);return e};d.prototype.openComponentData=function(a,c,e){a.setRequest(e);var d=this._registry.list(),g,k=d.length;for(g=0;g<k;g++){var l=c.components[d[g].id];l&&this._registry[d[g].id].addComponent(a,l)}a.setRequest(null);d=c.children.length;k=a.getChildren();for(g=
0;g<d;g++)k[g]=this.openComponentData(k[g],c.children[g],e);return a};var a;a=pc.inherits(function(){},pc.resources.ResourceRequest);a.prototype.type="pack";a.prototype.Type=pc.fw.Pack;return{PackResourceHandler:d,PackRequest:a}}());pc.extend(pc.fw,function(){var d=function(){};d.prototype={add:function(a,b){if(this[a])throw Error(pc.string.format("ComponentSystem name '{0}' already registered or not allowed",a));this[a]=b;b.name=a},remove:function(a){if(!this[a])throw Error(pc.string.format("No ComponentSystem named '{0}' registered",a));delete this[a]},list:function(){var a=Object.keys(this),b={collisionrect:0.5,collisioncircle:0.5};a.sort(function(a,e){var d=b[a]||1,g=b[e]||1;return d<g?-1:d>g?1:0});return a.map(function(a){return this[a]},
...
a.model.material;b.model.data.enabled=a.model.enabled;a.model.model&&(b.model.model=a.model.model.clone())}});return{ModelComponentSystem:d}}());pc.extend(pc.fw,function(){var d=function(a){this.on("set_type",this.onSetType,this);this.on("set_asset",this.onSetAsset,this);this.on("set_castShadows",this.onSetCastShadows,this);this.on("set_model",this.onSetModel,this);this.on("set_receiveShadows",this.onSetReceiveShadows,this);this.on("set_material",this.onSetMaterial,this);Object.defineProperty(this,"materialAsset",{set:this.setMaterialAsset.bind(this),get:this.getMaterialAsset.bind(this)});this.materialLoader=new pc.resources.MaterialResourceLoader(a.context.graphicsDevice,
a.context.assets)},d=pc.inherits(d,pc.fw.Component);pc.extend(d.prototype,{setVisible:function(a){console.warn("WARNING: setVisible: Function is deprecated. Set enabled property instead.");this.enabled=a},loadModelAsset:function(a){function b(a){a=a[0];this.system.context.designer&&a.generateWireframe();e.on("change",this.onAssetChange,this);"asset"===this.data.type&&(this.model=a)}var c={parent:this.entity.getRequest()},e=this.system.context.assets.getAssetByResourceId(a);e?e.resource?setTimeout(function(){var a=
e.resource.clone();b.call(this,[a])}.bind(this),0):this.system.context.assets.load(e,[],c).then(b.bind(this)):logERROR(pc.string.format("Trying to load model before asset {0} is loaded.",a))},onSetType:function(a,b,c){a=this.data;if(c)if(b=null,"asset"===c)this.data.asset?this.loadModelAsset(this.data.asset):this.model=null;else{switch(c){case "box":b=this.system.box;break;case "capsule":b=this.system.capsule;break;case "sphere":b=this.system.sphere;break;case "cone":b=this.system.cone;break;case "cylinder":b=
this.system.cylinder;break;default:throw Error("Invalid model type: "+c);}var c=new pc.scene.GraphNode,e=new pc.scene.Model;e.graph=c;e.meshInstances=[new pc.scene.MeshInstance(c,b,a.material)];this.system.context.designer&&e.generateWireframe();this.model=e}},onSetAsset:function(a,b,c){b&&(a=this.system.context.assets.getAssetByResourceId(b))&&a.off("change",this.onAssetChange,this);"asset"===this.data.type&&(c?c instanceof pc.asset.Asset?(this.data.asset=c.resourceId,this.loadModelAsset(c.resourceId)):
this.loadModelAsset(c):this.model=null)},onSetCastShadows:function(a,b,c){if(a=this.data.model){var b=this.system.context.scene,e=b.containsModel(a);e&&b.removeModel(a);for(var d=a.meshInstances,g=0;g<d.length;g++)d[g].castShadow=c;e&&b.addModel(a)}},onSetModel:function(a,b,c){b&&(this.system.context.scene.removeModel(b),this.entity.removeChild(b.getGraph()),delete b._entity);if(c){for(var a=this.data,b=c.meshInstances,e=0;e<b.length;e++)b[e].castShadow=a.castShadows,b[e].receiveShadow=a.receiveShadows;
this.entity.addChild(c.graph);this.enabled&&this.entity.enabled&&this.system.context.scene.addModel(c);c._entity=this.entity;this.entity.animation&&this.entity.animation.setModel(c)}},setMaterialAsset:function(a){var a="string"===typeof a||!a?a:a.resourceId,b;a&&(b=this.materialLoader.load(a));b||(b=this.system.defaultMaterial);this.material=b;b=this.data.materialAsset;this.data.materialAsset=a;this.fire("set","materialAsset",b,a)},getMaterialAsset:function(){return this.system.context.assets.getAssetByResourceId(this.data.materialAsset)},
onSetMaterial:function(a,b,c){if(c!==b&&(this.data.material=c,this.data.model&&"asset"!==this.data.type)){a=this.data.model.meshInstances;for(b=0;b<a.length;b++)a[b].material=c}},onSetReceiveShadows:function(a,b,c){if(void 0!==c&&(a=this.data,a.model)){a=a.model.meshInstances;for(b=0;b<a.length;b++)a[b].receiveShadow=c}},onEnable:function(){d._super.onEnable.call(this);var a=this.data.model;a&&(this.system.context.scene.containsModel(a)||this.system.context.scene.addModel(a))},onDisable:function(){d._super.onDisable.call(this);
var a=this.data.model;a&&this.system.context.scene.containsModel(a)&&this.system.context.scene.removeModel(a)},onAssetChange:function(a){a.resource=null;this.system.context.loader.removeFromCache(a.getFileUrl());this.asset=null;this.asset=a.resourceId}});return{ModelComponent:d}}());pc.extend(pc.fw,function(){var d;d=pc.inherits(function(){this.enabled=!0;this.type="asset";this.asset=null;this.castShadows=!1;this.receiveShadows=!0;this.model=this.material=this.materialAsset=null},pc.fw.ComponentData);return{ModelComponentData:d}}());pc.extend(pc.fw,function(){var d=function(a){this.id="skybox";this.description="Renders a skybox in the scene.";a.systems.add(this.id,this);this.ComponentType=pc.fw.SkyboxComponent;this.DataType=pc.fw.SkyboxComponentData;this.schema=[{name:"enabled",displayName:"Enabled",description:"Enables or disables the component",type:"boolean",defaultValue:!0},{name:"posx",displayName:"POSX",description:"URL of the positive X face of skybox cubemap",type:"asset",options:{max:1,type:"texture"},defaultValue:null},
...
d._super.initializeComponentData.call(this,a,b,c)},onRemove:function(a,b){b.model&&(this.context.scene.removeModel(b.model),a.removeChild(b.model.getGraph()),b.model=null)}});return{SkyboxComponentSystem:d}}());pc.extend(pc.fw,function(){var d=function(){this.on("set",this.onSet,this)},d=pc.inherits(d,pc.fw.Component);pc.extend(d.prototype,{onSet:function(b,c,e){function d(b,c){if(c){var e=a.indexOf(b),f=this.entity.skybox.assets;this.data.model=null;if(c)if(f[e]=this.system.context.assets.getAssetByResourceId(c),f[e]){if(this.data.assets=f,f[0]&&f[1]&&f[2]&&f[3]&&f[4]&&f[5]){var g=f.map(function(a){return a.getFileUrl()}),e=this.data,s=this.entity,h=this.system.context,f=h.graphicsDevice,v=new pc.gfx.Texture(f,
{format:pc.gfx.PIXELFORMAT_R8_G8_B8,cubemap:!0});v.minFilter=pc.gfx.FILTER_LINEAR_MIPMAP_LINEAR;v.magFilter=pc.gfx.FILTER_LINEAR;v.addressU=pc.gfx.ADDRESS_CLAMP_TO_EDGE;v.addressV=pc.gfx.ADDRESS_CLAMP_TO_EDGE;s={parent:s.getRequest()};g=g.map(function(a){return new pc.resources.ImageRequest(a)});h.loader.request(g,s).then(function(a){v.setSource(a)});h=f.getProgramLibrary().getProgram("skybox");g=new pc.scene.Material;g.setShader(h);g.setParameter("texture_cubeMap",v);g.cull=pc.gfx.CULLFACE_NONE;
h=new pc.scene.GraphNode;f=pc.scene.procedural.createBox(f);f=new pc.scene.MeshInstance(h,f,g);g=new pc.scene.Model;g.graph=h;g.meshInstances=[f];e.model=g;this.enabled&&this.entity.enabled&&(this.system.context.scene.addModel(this.data.model),this.entity.addChild(this.data.model.graph))}}else logERROR(pc.string.format("Trying to load skybox component before asset {0} has loaded",c));else delete f[e]}}var g={posx:function(a,b,c,e){d.call(this,b,e)},negx:function(a,b,c,e){d.call(this,b,e)},posy:function(a,
b,c,e){d.call(this,b,e)},negy:function(a,b,c,e){d.call(this,b,e)},posz:function(a,b,c,e){d.call(this,b,e)},negz:function(a,b,c,e){d.call(this,b,e)}};g[b]&&g[b].call(this,this.entity,b,c,e)},onEnable:function(){d._super.onEnable.call(this);this.data.model&&!this.system.context.scene.containsModel(this.data.model)&&(this.system.context.scene.addModel(this.data.model),this.entity.addChild(this.data.model.graph))},onDisable:function(){d._super.onDisable.call(this);this.data.model&&this.system.context.scene.containsModel(this.data.model)&&
(this.entity.removeChild(this.data.model.graph),this.system.context.scene.removeModel(this.data.model))}});var a="posx negx posy negy posz negz".split(" ");return{SkyboxComponent:d}}());pc.extend(pc.fw,function(){var d;d=pc.inherits(function(){this.enabled=!0;this.negz=this.posz=this.negy=this.posy=this.negx=this.posx=null;this.assets=[];this.model=null},pc.fw.ComponentData);return{SkyboxComponentData:d}}());pc.extend(pc.fw,function(){var d=function(a){this.id="camera";this.description="Renders the scene from the location of the Entity.";a.systems.add(this.id,this);this.ComponentType=pc.fw.CameraComponent;this.DataType=pc.fw.CameraComponentData;this.schema=[{name:"enabled",displayName:"Enabled",description:"Disabled cameras do not render anything",type:"boolean",defaultValue:!0},{name:"clearColorBuffer",displayName:"Clear Color Buffer",description:"Clear color buffer",type:"boolean",defaultValue:!0},
{name:"clearColor",displayName:"Clear Color",description:"Clear Color",type:"rgba",defaultValue:[0.7294117647058823,0.7294117647058823,0.6941176470588235,1],filter:{clearColorBuffer:!0}},{name:"clearDepthBuffer",displayName:"Clear Depth Buffer",description:"Clear depth buffer",type:"boolean",defaultValue:!0},{name:"projection",displayName:"Projection",description:"Projection type of camera",type:"enumeration",options:{enumerations:[{name:"Perspective",value:0},{name:"Orthographic",value:1}]},defaultValue:0},
{name:"fov",displayName:"Field of View",description:"Field of view in Y axis",type:"number",defaultValue:45,options:{min:0,max:90},filter:{projection:0}},{name:"orthoHeight",displayName:"Ortho Height",description:"View window half extent of camera in Y axis",type:"number",defaultValue:100,filter:{projection:1}},{name:"nearClip",displayName:"Near Clip",description:"Near clipping distance",type:"number",defaultValue:0.3,options:{min:1E-4,decimalPrecision:3}},{name:"farClip",displayName:"Far Clip",description:"Far clipping distance",
type:"number",defaultValue:1E3,options:{min:1E-4,decimalPrecision:3}},{name:"priority",displayName:"Priority",description:"Controls which camera will be rendered first. Smaller numbers are rendered first.",type:"number",defaultValue:0},{name:"rect",displayName:"Viewport",description:"Controls where on the screen the camera will be rendered in normalized coordinates.",type:"vector",defaultValue:[0,0,1,1]},{name:"camera",exposed:!1},{name:"aspectRatio",exposed:!1},{name:"model",exposed:!1},{name:"renderTarget",
...
b.enabled=b.activate);b.camera=new pc.scene.CameraNode;b.postEffects=new pc.posteffect.PostEffectQueue(this.context,a);if(this.context.designer&&this.displayInTools(a.entity)){c=new pc.scene.BasicMaterial;c.color=new pc.Color(1,1,0,1);c.update();var e=new pc.gfx.IndexBuffer(this.context.graphicsDevice,pc.gfx.INDEXFORMAT_UINT8,24);(new Uint8Array(e.lock())).set([0,1,1,2,2,3,3,0,4,5,5,6,6,7,7,4,0,4,1,5,2,6,3,7]);e.unlock();var f=new pc.gfx.VertexFormat(this.context.graphicsDevice,[{semantic:pc.gfx.SEMANTIC_POSITION,
components:3,type:pc.gfx.ELEMENTTYPE_FLOAT32}]),g=new pc.gfx.VertexBuffer(this.context.graphicsDevice,f,8,pc.gfx.BUFFER_DYNAMIC),f=new pc.scene.Mesh;f.vertexBuffer=g;f.indexBuffer[0]=e;f.primitive[0].type=pc.gfx.PRIMITIVE_LINES;f.primitive[0].base=0;f.primitive[0].count=e.getNumIndices();f.primitive[0].indexed=!0;e=new pc.scene.Model;e.graph=b.camera;e.meshInstances=[new pc.scene.MeshInstance(e.graph,f,c)];this.context.scene.addModel(e);b.model=e}c="postEffects enabled model camera aspectRatio renderTarget clearColor fov orthoHeight nearClip farClip projection priority clearColorBuffer clearDepthBuffer rect".split(" ");
...
0<=b&&this.instancesWithToolsUpdate.splice(b,1));a.instances[e].instance===a[e]&&delete a[e];delete a.instances[e]}},_postInitializeScriptComponent:function(a){this._callInstancesMethod(a,"postInitialize");a.data.postInitialized=!0},_updateInstances:function(a,b,c){for(var e,d=0,g=b.length;d<g;d++)(e=b[d])&&(e.entity.script.enabled&&e.entity.enabled)&&e[a].call(e,c)},onUpdate:function(a){this._updateInstances("update",this.instancesWithUpdate,a)},onFixedUpdate:function(a){this._updateInstances("fixedUpdate",
this.instancesWithFixedUpdate,a)},onPostUpdate:function(a){this._updateInstances("postUpdate",this.instancesWithPostUpdate,a)},onToolsUpdate:function(a){this._updateInstances("toolsUpdate",this.instancesWithToolsUpdate,a)},broadcast:function(a,b){var c=pc.makeArray(arguments).slice(2),e,d,g,k=this.store;for(e in k)k.hasOwnProperty(e)&&(d=k[e].data,d.instances[a]&&(g=d.instances[a].instance[b])&&g.apply(d.instances[a].instance,c))},_preRegisterInstance:function(a,b,c,e){if(a.script){a.script.data._instances=
...
a,b,c);"undefined"!==typeof Box2D&&this.createBody(a)},createBody:function(b){if(b.entity.collisionrect||b.entity.collisioncircle){var c=new g;d.copy(b.entity.getPosition());a.copy(b.entity.getEulerAngles());c.type=b.static?f.b2_staticBody:f.b2_dynamicBody;c.position.Set(d.data[this.xi],d.data[this.yi]);var e=b._eulersToAngle(a);c.angle=-e*pc.math.DEG_TO_RAD;c.userData=b.entity;b.data.bodyDef=c}b.data.body&&this.removeBody(b.entity,b.data.body);b.data.body=b.entity.collisionrect?this.addBody(b.bodyDef,
...
raycast:function(a,b,c){var d=new e,g=new e;this.to2d(b,d);this.to2d(c,g);this._rayStart.vec3.copy(b);this._rayEnd.vec3.copy(c);this.b2World.RayCast(a,d,g)},raycastFirst:function(a,b,c){var e,d=1;this.raycast(function(a,b,g,f){a=a.GetUserData();a!==c&&f<d&&(e=a,d=f);return 1},a,b);return e},onUpdate:function(a){var b=this.store,c;for(c in b)if(b.hasOwnProperty(c)){var e=b[c].entity,d=b[c].data;d.body&&!d.static&&e.body2d.updateTransform(d.body)}for(this.time+=a;this.time>this.step;)this.b2World.Step(this.step,
6,2),this.time-=this.step}});return{Body2dComponentSystem:k}}());pc.extend(pc.fw,function(){new pc.Mat4;var d=new pc.Vec3,a=new pc.Vec3,b=function(a,b){this.on("set_static",this.onSetStatic,this);b.on("livelink:updatetransform",this.onLiveLinkUpdateTransform,this)},b=pc.inherits(b,pc.fw.Component);pc.extend(b.prototype,{applyForce:function(a,b){var f=this.entity.body2d.body;f&&(b||(b=d,b[this.system.xi]=f.GetPosition().x,b[this.system.yi]=f.GetPosition().y),f.ApplyForce({x:a[this.system.xi],y:a[this.system.yi]},{x:b[this.system.xi],y:b[this.system.yi]}))},applyImpulse:function(a,
b){var f=this.entity.body2d.body;f&&(b||(b=d,b[this.system.xi]=f.GetPosition().x,b[this.system.yi]=f.GetPosition().y),f.ApplyImpulse({x:a[this.system.xi],y:a[this.system.yi]},{x:b[this.system.xi],y:b[this.system.yi]}))},setLinearVelocity:function(a,b){var d=this.entity.body2d.body;if(d){var g=d.GetLinearVelocity();g.x=a;g.y=b;d.SetLinearVelocity(g)}},setAngularVelocity:function(a){var b=this.entity.body2d.body;b&&b.SetAngularVelocity(a)},setTransform:function(b){b.getTranslation(d);b.getEulerAngles(a);
b=this._eulersToAngle(a);this.setPositionAndAngle(d.data[this.system.xi],d.data[this.system.yi],-b)},setPosition:function(a,b){var d=this.entity.body2d.body;if(d){d.SetAwake(!0);var g=d.GetPosition();g.x=a;g.y=b;d.SetPosition(g);this.updateTransform(d)}},setAngle:function(a){var b=this.entity.body2d.body;b&&(b.SetAwake(!0),b.SetAngle(a*pc.math.DEG_TO_RAD),this.updateTransform(b))},setPositionAndAngle:function(a,b,d){var g=this.entity.body2d.body;if(g){g.SetAwake(!0);var k=g.GetPosition();k.x=a;k.y=
b;g.SetPositionAndAngle(k,d*pc.math.DEG_TO_RAD);this.updateTransform(g)}},getAngle:function(){return this.entity.body2d.body.GetAngle()*pc.math.RAD_TO_DEG},setLinearDamping:function(a,b){var d=this.entity.body2d.body;d&&d.SetLinearDamping(b)},updateTransform:function(b){var e=this.entity.getPosition();this.entity.getLocalEulerAngles();var f=b.GetPosition();d.data[this.system.xi]=f.x;d.data[this.system.ri]=e.y;d.data[this.system.yi]=f.y;a.data[this.system.xi]=0;a.data[this.system.ri]=-b.GetAngle()*
...
step:0.1},defaultValue:0.5},{name:"y",displayName:"Size: Y",description:"The size of the Rect in the y-axis",type:"number",options:{min:0,step:0.1},defaultValue:0.5},{name:"model",expose:!1}];this.exposeProperties();var c=c.graphicsDevice,f=new pc.gfx.VertexFormat(c,[{semantic:pc.gfx.SEMANTIC_POSITION,components:3,type:pc.gfx.ELEMENTTYPE_FLOAT32}]),f=new pc.gfx.VertexBuffer(c,f,4);(new Float32Array(f.lock())).set([-0.5,0,-0.5,-0.5,0,0.5,0.5,0,0.5,0.5,0,-0.5]);f.unlock();c=new pc.gfx.IndexBuffer(c,
pc.gfx.INDEXFORMAT_UINT8,8);(new Uint8Array(c.lock())).set([0,1,1,2,2,3,3,0]);c.unlock();this.mesh=new pc.scene.Mesh;this.mesh.vertexBuffer=f;this.mesh.indexBuffer[0]=c;this.mesh.primitive[0].type=pc.gfx.PRIMITIVE_LINES;this.mesh.primitive[0].base=0;this.mesh.primitive[0].count=c.getNumIndices();this.mesh.primitive[0].indexed=!0;this.material=new pc.scene.BasicMaterial;this.material.color=new pc.Color(0,0,1,1);this.material.update();this.debugRender=!1;this.on("remove",this.onRemove,this);pc.fw.ComponentSystem.on("update",
...
a),a.entity.body2d&&this.context.systems.body2d.createBody(a.entity.body2d))},createFixtureDef:function(c,d){var g=new a;g.density=d.density;g.friction=d.friction;g.restitution=d.restitution;g.shape=new b;g.shape.SetAsBox(d.x,d.y);g.userData=c;return g},onRemove:function(a,b){a.body2d&&a.body2d.body&&this.context.systems.body2d.removeBody(a,a.body2d.body);this.context.scene.containsModel(b.model)&&(this.context.scene.removeModel(b.model),this.context.root.removeChild(b.model.graph))},setDebugRender:function(a){this.debugRender=
...
type:"number",options:{min:0,step:0.1},defaultValue:1},{name:"model",exposed:!1}];this.exposeProperties();var f=c.graphicsDevice,c=new pc.gfx.VertexFormat(f,[{semantic:pc.gfx.SEMANTIC_POSITION,components:3,type:pc.gfx.ELEMENTTYPE_FLOAT32}]),c=new pc.gfx.VertexBuffer(f,c,41),g=new Float32Array(c.lock()),k,l=c.getNumVertices();for(k=0;k<l-1;k++){var n=2*Math.PI*(k/(l-2)),r=0.5*Math.cos(n),n=0.5*Math.sin(n);g[3*k+0]=r;g[3*k+1]=0;g[3*k+2]=n}c.unlock();f=new pc.gfx.IndexBuffer(f,pc.gfx.INDEXFORMAT_UINT8,
80);g=new Uint8Array(f.lock());for(k=0;40>k;k++)g[2*k+0]=k,g[2*k+1]=k+1;f.unlock();this.mesh=new pc.scene.Mesh;this.mesh.vertexBuffer=c;this.mesh.indexBuffer[0]=f;this.mesh.primitive[0].type=pc.gfx.PRIMITIVE_LINES;this.mesh.primitive[0].base=0;this.mesh.primitive[0].count=f.getNumIndices();this.mesh.primitive[0].indexed=!0;this.material=new pc.scene.BasicMaterial;this.material.color=pc.Color(0,0,1,1);this.material.update();this.debugRender=!1;this.on("remove",this.onRemove,this);pc.fw.ComponentSystem.on("update",
...
a),a.entity.body2d&&this.context.systems.body2d.createBody(a.entity.body2d))},createFixtureDef:function(c,d){var g=new a;g.density=d.density;g.friction=d.friction;g.restitution=d.restitution;g.shape=new b;g.shape.SetRadius(d.radius);g.userData=c;return g},onRemove:function(a,b){a.body2d&&a.body2d.body&&this.context.systems.body2d.removeBody(a,a.body2d.body);this.context.scene.containsModel(b.model)&&(this.context.scene.removeModel(b.model),this.context.root.removeChild(b.model.graph))},setDebugRender:function(a){this.debugRender=
...
this._ammoGravity.setValue(a,b,c);this.dynamicsWorld.setGravity(this._ammoGravity)},raycastFirst:function(b,c,e){d.setValue(b.x,b.y,b.z);a.setValue(c.x,c.y,c.z);b=new Ammo.ClosestRayResultCallback(d,a);this.dynamicsWorld.rayTest(d,a,b);if(b.hasHit()){var c=b.get_m_collisionObject(),c=Ammo.wrapPointer(c,Ammo.btCollisionObject),c=Ammo.castObject(c,Ammo.btRigidBody),g=b.get_m_hitPointWorld(),f=b.get_m_hitNormalWorld();c&&e(new k(c.entity,new pc.Vec3(g.x(),g.y(),g.z()),new pc.Vec3(f.x(),f.y(),f.z())))}Ammo.destroy(b)},
_storeCollision:function(a,d){var e=!1,g=a.getGuid();b[g]=b[g]||{others:[],entity:a};0>b[g].others.indexOf(d)&&(b[g].others.push(d),e=!0);c[g]=c[g]||{others:[],entity:a};c[g].others.push(d);return e},_handleEntityCollision:function(a,b,c,d){var e;d&1&&(e=new r(b,c),a.collision.fire("contact",e));d&30&&this._storeCollision(a,b)&&(d&2&&(e=e||new r(b,c),a.collision.fire("collisionstart",e)),d&8&&a.collision.fire("triggerenter",b))},_createContactPointFromAmmo:function(a){var b=new pc.Vec3(a.get_m_localPointA().x(),
a.get_m_localPointA().y(),a.get_m_localPointA().z()),c=new pc.Vec3(a.get_m_localPointB().x(),a.get_m_localPointB().y(),a.get_m_localPointB().z()),d=new pc.Vec3(a.getPositionWorldOnA().x(),a.getPositionWorldOnA().y(),a.getPositionWorldOnA().z()),e=new pc.Vec3(a.getPositionWorldOnB().x(),a.getPositionWorldOnB().y(),a.getPositionWorldOnB().z()),a=new pc.Vec3(a.get_m_normalWorldOnB().x(),a.get_m_normalWorldOnB().y(),a.get_m_normalWorldOnB().z());return new n(b,c,d,e,a)},_createReverseContactPointFromAmmo:function(a){var b=
new pc.Vec3(a.get_m_localPointA().x(),a.get_m_localPointA().y(),a.get_m_localPointA().z()),c=new pc.Vec3(a.get_m_localPointB().x(),a.get_m_localPointB().y(),a.get_m_localPointB().z()),d=new pc.Vec3(a.getPositionWorldOnA().x(),a.getPositionWorldOnA().y(),a.getPositionWorldOnA().z()),e=new pc.Vec3(a.getPositionWorldOnB().x(),a.getPositionWorldOnB().y(),a.getPositionWorldOnB().z()),a=new pc.Vec3(-a.get_m_normalWorldOnB().x(),-a.get_m_normalWorldOnB().y(),-a.get_m_normalWorldOnB().z());return new n(c,
b,e,d,a)},_cleanOldCollisions:function(){for(var a in b)if(b.hasOwnProperty(a)){for(var d=b[a].entity,e=d.collision,g=b[a].others,f=g.length;f--;){var k=g[f];if(!c[a]||0>c[a].others.indexOf(k))if(g.splice(f,1),e&&k.collision){var l=this._getCollisionFlags(d,k);l&4&&e.fire("collisionend",k);l&16&&e.fire("triggerleave",k)}}0===g.length&&delete b[a]}},_getCollisionFlags:function(a,b){var c=a.rigidbody,d=b.rigidbody,e=!c,f=!d;if(e&&f)return 0;var k=this.store,c=c&&k[a.getGuid()].data.type!==pc.fw.RIGIDBODY_TYPE_STATIC,
d=d&&k[b.getGuid()].data.type!==pc.fw.RIGIDBODY_TYPE_STATIC,l=k=0;c?k=1:e&&(k=2);d?l=1:f&&(l=2);if(e=g[k][l])f=a.collision,this.hasEvent("contact")||(e&=-33),f.hasEvent("contact")||(e&=-2),f.hasEvent("collisionstart")||(e&=-3),f.hasEvent("collisionend")||(e&=-5),f.hasEvent("triggerenter")||(e&=-9),f.hasEvent("triggerleave")||(e&=-17);return e},onUpdate:function(a){this.dynamicsWorld.stepSimulation(a,this.maxSubSteps,this.fixedTimeStep);var b=this.store,d;for(d in b)if(b.hasOwnProperty(d)){var g=b[d].entity,
k=b[d].data;k.body&&(k.body.isActive()&&k.enabled&&g.enabled)&&(k.type===pc.fw.RIGIDBODY_TYPE_DYNAMIC?g.rigidbody.syncBodyToEntity():k.type===pc.fw.RIGIDBODY_TYPE_KINEMATIC&&g.rigidbody.updateKinematic(a))}var a=this.dynamicsWorld.getDispatcher(),b=a.getNumManifolds(),n;c={};for(d=0;d<b;d++){g=a.getManifoldByIndexInternal(d);n=g.getBody0();k=g.getBody1();n=Ammo.castObject(n,Ammo.btRigidBody);var m=Ammo.castObject(k,Ammo.btRigidBody),k=n.entity,m=m.entity;if(k&&m){var r=this._getCollisionFlags(k,m),
z=this._getCollisionFlags(m,k);if(r||z){var C=g.getNumContacts();if(0<C){var D,G=r&2||r&1,x=z&2||z&1;e.length=0;for(n=f.length=0;n<C;n++){var B=g.getContactPoint(n);r&32&&(D=this._createContactPointFromAmmo(B),this.fire("contact",new l(k,m,D)));G&&(D=D||this._createContactPointFromAmmo(B),e.push(D));x&&f.push(this._createReverseContactPointFromAmmo(B))}this._handleEntityCollision(k,m,e,r);this._handleEntityCollision(m,k,f,z)}}}}this._cleanOldCollisions()}});return{RIGIDBODY_TYPE_STATIC:"static",RIGIDBODY_TYPE_DYNAMIC:"dynamic",
RIGIDBODY_TYPE_KINEMATIC:"kinematic",RIGIDBODY_CF_STATIC_OBJECT:1,RIGIDBODY_CF_KINEMATIC_OBJECT:2,RIGIDBODY_CF_NORESPONSE_OBJECT:4,RIGIDBODY_ACTIVE_TAG:1,RIGIDBODY_ISLAND_SLEEPING:2,RIGIDBODY_WANTS_DEACTIVATION:3,RIGIDBODY_DISABLE_DEACTIVATION:4,RIGIDBODY_DISABLE_SIMULATION:5,RigidBodyComponentSystem:m}}());pc.extend(pc.fw,function(){var d,a,b,c,e,f=function(g,f){"undefined"!==typeof Ammo&&!d&&(d=new Ammo.btTransform,a=new Ammo.btVector3,b=new Ammo.btVector3,c=new Ammo.btQuaternion,e=new Ammo.btVector3(0,0,0));this.on("set_mass",this.onSetMass,this);this.on("set_linearDamping",this.onSetLinearDamping,this);this.on("set_angularDamping",this.onSetAngularDamping,this);this.on("set_linearFactor",this.onSetLinearFactor,this);this.on("set_angularFactor",this.onSetAngularFactor,this);this.on("set_friction",
this.onSetFriction,this);this.on("set_restitution",this.onSetRestitution,this);this.on("set_type",this.onSetType,this);this.on("set_body",this.onSetBody,this);f.on("livelink:updatetransform",this.onLiveLinkUpdateTransform,this);this.system.on("beforeremove",this.onBeforeRemove,this);this._displacement=new pc.Vec3(0,0,0);this._linearVelocity=new pc.Vec3(0,0,0);this._angularVelocity=new pc.Vec3(0,0,0)},f=pc.inherits(f,pc.fw.Component);Object.defineProperty(f.prototype,"bodyType",{get:function(){console.warn("WARNING: bodyType: Function is deprecated. Query type property instead.");
...
d;b.collision&&(d=b.collision.shape,b.trigger&&(b.trigger.destroy(),delete b.trigger));if(d){this.body&&(this.system.removeBody(this.body),Ammo.destroy(this.body));var e=this.isStaticOrKinematic(),f=e?0:this.mass,r=new Ammo.btVector3(0,0,0);e||d.calculateLocalInertia(f,r);var e=b.getPosition(),m=b.getRotation();c.setValue(m.x,m.y,m.z,m.w);m=new Ammo.btTransform;m.setIdentity();m.getOrigin().setValue(e.x,e.y,e.z);m.setRotation(c);e=new Ammo.btDefaultMotionState(m);d=new Ammo.btRigidBodyConstructionInfo(f,
e,d,r);d=new Ammo.btRigidBody(d);d.setRestitution(this.restitution);d.setFriction(this.friction);d.setDamping(this.linearDamping,this.angularDamping);f=this.linearFactor;a.setValue(f.x,f.y,f.z);d.setLinearFactor(a);f=this.angularFactor;a.setValue(f.x,f.y,f.z);d.setAngularFactor(a);d.entity=b;this.isKinematic()&&(d.setCollisionFlags(d.getCollisionFlags()|pc.fw.RIGIDBODY_CF_KINEMATIC_OBJECT),d.setActivationState(pc.fw.RIGIDBODY_DISABLE_DEACTIVATION));b.rigidbody.body=d;this.enabled&&this.entity.enabled&&
...
disableSimulation:function(){var a=this.body;a&&this.data.simulationEnabled&&(this.system.removeBody(a),a.forceActivationState(pc.fw.RIGIDBODY_DISABLE_SIMULATION),this.data.simulationEnabled=!1)},applyForce:function(){var c,d,f,n,r,m;switch(arguments.length){case 1:c=arguments[0].x;d=arguments[0].y;f=arguments[0].z;break;case 2:c=arguments[0].x;d=arguments[0].y;f=arguments[0].z;n=arguments[1].x;r=arguments[1].y;m=arguments[1].z;break;case 3:c=arguments[0];d=arguments[1];f=arguments[2];break;case 6:c=
arguments[0],d=arguments[1],f=arguments[2],n=arguments[3],r=arguments[4],m=arguments[5]}var s=this.body;s&&(s.activate(),a.setValue(c,d,f),"undefined"!==typeof n?(b.setValue(n,r,m),s.applyForce(a,b)):s.applyForce(a,e))},applyTorque:function(){var b,c,d;switch(arguments.length){case 1:b=arguments[0].x;c=arguments[0].y;d=arguments[0].z;break;case 3:b=arguments[0];c=arguments[1];d=arguments[2];break;default:console.error("ERROR: applyTorque: function takes 1 or 3 arguments");return}var e=this.body;e&&
(e.activate(),a.setValue(b,c,d),e.applyTorque(a))},applyImpulse:function(){var c,d,f,n,r,m;switch(arguments.length){case 1:c=arguments[0].x;d=arguments[0].y;f=arguments[0].z;break;case 2:c=arguments[0].x;d=arguments[0].y;f=arguments[0].z;n=arguments[1].x;r=arguments[1].y;m=arguments[1].z;break;case 3:c=arguments[0];d=arguments[1];f=arguments[2];break;case 6:c=arguments[0],d=arguments[1],f=arguments[2],n=arguments[0],r=arguments[1],m=arguments[2]}var s=this.body;s&&(s.activate(),a.setValue(c,d,f),
...
a.y,a.z);c.setValue(b.x,b.y,b.z,b.w);d.setRotation(c);this.body.getMotionState().setWorldTransform(d)}},onEnable:function(){f._super.onEnable.call(this);this.body||this.createBody();this.enableSimulation()},onDisable:function(){f._super.onDisable.call(this);this.disableSimulation()},onSetMass:function(a,b,c){if(a=this.data.body){(b=this.enabled&&this.entity.enabled)&&this.disableSimulation();var d=new Ammo.btVector3(0,0,0);a.getCollisionShape().calculateLocalInertia(c,d);a.setMassProps(c,d);a.updateInertiaTensor();
...
0,1,1),c.update(),this.material=c);return new pc.scene.MeshInstance(a.model.graph,this.mesh,this.material)},createPhysicalShape:function(a,b){if("undefined"!==typeof Ammo){var c=b.halfExtents,c=new Ammo.btVector3(c.x,c.y,c.z);return new Ammo.btBoxShape(c)}},updateDebugShape:function(a,b){var c=b.halfExtents,d=c.x,f=c.y,c=c.z,g=b.model.graph;g.setPosition(a.getPosition());g.setRotation(a.getRotation());g.setLocalScale(2*d,2*f,2*c)}});CollisionSphereSystemImpl=function(){};CollisionSphereSystemImpl=
pc.inherits(CollisionSphereSystemImpl,CollisionSystemImpl);CollisionSphereSystemImpl.prototype=pc.extend(CollisionSphereSystemImpl.prototype,{createDebugMesh:function(a){if(!this.mesh){for(var b=this.system.context.graphicsDevice,c=new pc.gfx.VertexFormat(b,[{semantic:pc.gfx.SEMANTIC_POSITION,components:3,type:pc.gfx.ELEMENTTYPE_FLOAT32}]),b=new pc.gfx.VertexBuffer(b,c,240),c=new Float32Array(b.lock()),d,f=0,g,k=0;3>k;k++){var l=0,n=1,r=2;1===k?(l=1,n=0,r=2):2===k&&(l=0,n=2,r=1);for(d=0;40>d;d++)g=
2*Math.PI*(d/40),c[f+l]=0.5*Math.cos(g),c[f+n]=0,c[f+r]=0.5*Math.sin(g),f+=3,g=2*Math.PI*((d+1)/40),c[f+l]=0.5*Math.cos(g),c[f+n]=0,c[f+r]=0.5*Math.sin(g),f+=3}b.unlock();c=new pc.scene.Mesh;c.vertexBuffer=b;c.primitive[0].type=pc.gfx.PRIMITIVE_LINES;c.primitive[0].base=0;c.primitive[0].count=b.getNumVertices();c.primitive[0].indexed=!1;this.mesh=c}this.material||(b=new pc.scene.BasicMaterial,b.color=new pc.Color(0,0,1,1),b.update(),this.material=b);return new pc.scene.MeshInstance(a.model.graph,
...
b;this.material||(c=new pc.scene.BasicMaterial,c.color=new pc.Color(0,0,1,1),c.update(),this.material=c);return new pc.scene.MeshInstance(a.model.graph,b,this.material)},updateCapsuleShape:function(a,b){var c="undefined"!==typeof a.axis?a.axis:1,d=a.radius||0.5,f=Math.max((a.height||2)-2*d,0),g=new Float32Array(b.lock()),k=0,l=1,n=2;0===c?(k=1,l=0,n=2):2===c&&(k=0,l=2,n=1);var r=0,m;for(cap=-1;2>cap;cap+=2){for(c=0;40>c;c++)m=2*Math.PI*(c/40),g[r+k]=d*Math.cos(m),g[r+l]=0.5*cap*f,g[r+n]=d*Math.sin(m),
r+=3,m=2*Math.PI*((c+1)/40),g[r+k]=d*Math.cos(m),g[r+l]=0.5*cap*f,g[r+n]=d*Math.sin(m),r+=3;for(c=0;20>c;c++)m=Math.PI*(c/20)+1.5*Math.PI,g[r+k]=0,g[r+l]=cap*(0.5*f+d*Math.cos(m)),g[r+n]=cap*d*Math.sin(m),r+=3,m=Math.PI*((c+1)/20)+1.5*Math.PI,g[r+k]=0,g[r+l]=cap*(0.5*f+d*Math.cos(m)),g[r+n]=cap*d*Math.sin(m),r+=3;for(c=0;20>c;c++)m=Math.PI*(c/20)+1.5*Math.PI,g[r+k]=cap*d*Math.sin(m),g[r+l]=cap*(0.5*f+d*Math.cos(m)),g[r+n]=0,r+=3,m=Math.PI*((c+1)/20)+1.5*Math.PI,g[r+k]=cap*d*Math.sin(m),g[r+l]=cap*
(0.5*f+d*Math.cos(m)),g[r+n]=0,r+=3}for(c=0;4>c;c++)m=2*Math.PI*(c/4),g[r+k]=d*Math.cos(m),g[r+l]=0.5*f,g[r+n]=d*Math.sin(m),r+=3,m=2*Math.PI*(c/4),g[r+k]=d*Math.cos(m),g[r+l]=0.5*-f,g[r+n]=d*Math.sin(m),r+=3;b.unlock()},createPhysicalShape:function(a,b){var c=null,d="undefined"!==typeof b.axis?b.axis:1,f=b.radius||0.5,g=Math.max((b.height||2)-2*f,0);if("undefined"!==typeof Ammo)switch(d){case 0:c=new Ammo.btCapsuleShapeX(f,g);break;case 1:c=new Ammo.btCapsuleShape(f,g);break;case 2:c=new Ammo.btCapsuleShapeZ(f,
g)}return c},updateDebugShape:function(a,b){var c=b.model.graph;c.setPosition(a.getPosition());c.setRotation(a.getRotation());c.setLocalScale(1,1,1)},recreatePhysicalShapes:function(a){if(a.data.model){var b=this.createDebugMesh(a.data).mesh.vertexBuffer;this.updateCapsuleShape(a.data,b);CollisionCapsuleSystemImpl._super.recreatePhysicalShapes.call(this,a)}}});CollisionCylinderSystemImpl=function(){};CollisionCylinderSystemImpl=pc.inherits(CollisionCylinderSystemImpl,CollisionSystemImpl);CollisionCylinderSystemImpl.prototype=
...
0;b.primitive[0].count=c.getNumVertices();b.primitive[0].indexed=!1;this.material||(c=new pc.scene.BasicMaterial,c.color=new pc.Color(0,0,1,1),c.update(),this.material=c);return new pc.scene.MeshInstance(a.model.graph,b,this.material)},updateCylinderShape:function(a,b){var c="undefined"!==typeof a.axis?a.axis:1,d="undefined"!==typeof a.radius?a.radius:0.5,f="undefined"!==typeof a.height?a.height:1,g=new Float32Array(b.lock()),k=0,l=1,n=2;0===c?(k=1,l=0,n=2):2===c&&(k=0,l=2,n=1);var r=0,m;for(cap=
-1;2>cap;cap+=2)for(c=0;40>c;c++)m=2*Math.PI*(c/40),g[r+k]=d*Math.cos(m),g[r+l]=0.5*cap*f,g[r+n]=d*Math.sin(m),r+=3,m=2*Math.PI*((c+1)/40),g[r+k]=d*Math.cos(m),g[r+l]=0.5*cap*f,g[r+n]=d*Math.sin(m),r+=3;for(c=0;4>c;c++)m=2*Math.PI*(c/4),g[r+k]=d*Math.cos(m),g[r+l]=0.5*f,g[r+n]=d*Math.sin(m),r+=3,m=2*Math.PI*(c/4),g[r+k]=d*Math.cos(m),g[r+l]=0.5*-f,g[r+n]=d*Math.sin(m),r+=3;b.unlock()},createPhysicalShape:function(a,b){var c=null,c=null,d="undefined"!==typeof b.axis?b.axis:1,f="undefined"!==typeof b.radius?
b.radius:0.5,g="undefined"!==typeof b.height?b.height:1;if("undefined"!==typeof Ammo)switch(d){case 0:c=new Ammo.btVector3(0.5*g,f,f);c=new Ammo.btCylinderShapeX(c);break;case 1:c=new Ammo.btVector3(f,0.5*g,f);c=new Ammo.btCylinderShape(c);break;case 2:c=new Ammo.btVector3(f,f,0.5*g),c=new Ammo.btCylinderShapeZ(c)}return c},updateDebugShape:function(a,b){var c=b.model.graph;c.setPosition(a.getPosition());c.setRotation(a.getRotation());c.setLocalScale(1,1,1)},recreatePhysicalShapes:function(a){if(a.data.model){var b=
...
f,g;for(f=0;f<c.meshInstances.length;f++){var k=c.meshInstances[f],l=k.mesh,n=l.indexBuffer[pc.scene.RENDERSTYLE_SOLID],r=l.vertexBuffer,m=r.getFormat(),s=m.size/4,h;for(g=0;g<m.elements.length;g++){var v=m.elements[g];v.name===pc.gfx.SEMANTIC_POSITION&&(h=new Float32Array(r.lock(),v.offset))}var n=new Uint16Array(n.lock()),r=l.primitive[0].count/3,m=new Ammo.btVector3,v=new Ammo.btVector3,F=new Ammo.btVector3,y,u,w=l.primitive[0].base,A=new Ammo.btTriangleMesh;for(g=0;g<r;g++)l=n[w+3*g]*s,y=n[w+
3*g+1]*s,u=n[w+3*g+2]*s,m.setValue(h[l],h[l+1],h[l+2]),v.setValue(h[y],h[y+1],h[y+2]),F.setValue(h[u],h[u+1],h[u+2]),A.addTriangle(m,v,F,!0);g=new Ammo.btBvhTriangleMeshShape(A,!0);s=k.node.getWorldTransform().getScale();g.setLocalScaling(new Ammo.btVector3(s.x,s.y,s.z));s=k.node.getPosition();k=k.node.getRotation();n=new Ammo.btTransform;n.setIdentity();n.getOrigin().setValue(s.x,s.y,s.z);s=new Ammo.btQuaternion;s.setValue(k.x,k.y,k.z,k.w);n.setRotation(s);d.addChildShape(n,g)}c=a.getWorldTransform().getScale();
f=new Ammo.btVector3;f.setValue(c.x,c.y,c.z);d.setLocalScaling(f);return d}},recreatePhysicalShapes:function(a){var b=a.data;b.asset?this.loadModelAsset(a):(b.model=null,this.doRecreatePhysicalShape(a))},loadModelAsset:function(a){var b=a.data.asset,c=a.data,d={parent:a.entity.getRequest()},f=this.system.context.assets.getAssetByResourceId(b);f?this.system.context.assets.load(f,[],d).then(function(b){c.model=b[0];this.doRecreatePhysicalShape(a)}.bind(this)):logERROR(pc.string.format("Trying to load model before asset {0} is loaded.",
b))},doRecreatePhysicalShape:function(a){var b=a.entity,c=a.data;c.model?(c.shape&&Ammo.destroy(c.shape),c.shape=this.createPhysicalShape(b,c),b.rigidbody?b.rigidbody.createBody():b.trigger?b.trigger.initialize(c):b.trigger=new pc.fw.Trigger(this.system.context,a,c)):this.remove(b,c)},updateTransform:function(a,b,c,d){if(a.shape){var f=a.entity.getWorldTransform().getScale(),g=a.shape.getLocalScaling();(f.x!==g.x()||f.y!==g.y()||f.z!==g.z())&&this.doRecreatePhysicalShape(a)}CollisionMeshSystemImpl._super.updateTransform.call(this,
...
d.deserialize=function(a){var b=pc.json.parse(a.template),c=pc.json.parse(a.parent),d=pc.json.parse(a.children),f=pc.json.parse(a.transform),g=pc.json.parse(a.components),k=pc.json.parse(a.labels);return{_id:a._id,resource_id:a.resource_id,_rev:a._rev,name:a.name,enabled:a.enabled,labels:k,template:b,parent:c,children:d,transform:f,components:g}};d.serialize=function(a){var b={_id:a._id,resource_id:a.resource_id,name:a.name,enabled:a.enabled,labels:pc.json.stringify(a.labels),template:pc.json.stringify(a.template),
...
pc.extend(pc.asset,function(){var d=function(a,b,c,d,f){this.resourceId=pc.guid.create();this.name=a;this.type=b;this.file=c?{filename:c.filename,size:c.size,hash:c.hash,url:c.url}:null;this.data=d||{};this.prefix=f||"";this.resource=null;pc.events.attach(this)};d.prototype={getFileUrl:function(){if(!this.file)return null;var a=this.file.url,b="";this.prefix&&(b=this.prefix);return pc.path.join(b,a)}};return{Asset:d,ASSET_ANIMATION:"animation",ASSET_AUDIO:"audio",ASSET_IMAGE:"image",ASSET_JSON:"json",ASSET_MODEL:"model",
ASSET_MATERIAL:"material",ASSET_TEXT:"text",ASSET_TEXTURE:"texture"}}());pc.extend(pc.asset,function(){var d=function(a,b){if(!a)throw Error("Must provide a ResourceLoader instance for AssetRegistry");this.loader=a;this._prefix=b||"";this._cache={};this._names={};this._urls={}};d.prototype={update:function(a){for(var b in a.assets){var c=this.getAssetByResourceId(b);c?pc.extend(c,a.assets[b]):(c=a.assets[b],c=new pc.asset.Asset(c.name,c.type,c.file,c.data,this._prefix),c.resourceId=b,this.addAsset(c),c.file&&this.loader.registerHash(c.file.hash,c.getFileUrl()))}if(a.deleted)for(b in a.deleted)(c=
this.getAssetByResourceId(b))&&this.removeAsset(c)},all:function(){return Object.keys(this._cache).map(function(a){return this.getAssetByResourceId(a)},this)},addAsset:function(a){this._cache[a.resourceId]=a;this._names[a.name]||(this._names[a.name]=[]);this._names[a.name].push(a.resourceId);a.file&&(this._urls[a.file.url]=a.resourceId)},removeAsset:function(a){delete this._cache[a.resourceId];delete this._names[a.name];a.file&&delete this._urls[a.file.url]},findAll:function(a,b){var c=this,d=this._names[a];
return d?(d=d.map(function(a){return c._cache[a]}),b?d.filter(function(a){return a.type===b}):d):[]},find:function(a,b){var c=this.findAll(a,b);return c?c[0]:null},getAssetByResourceId:function(a){return this._cache[a]},getAssetByUrl:function(a){return this._cache[this._urls[a]]},getAssetByName:function(a){console.warn("WARNING: getAssetByName: Function is deprecated. Use find() or findAll() instead.");return this.find(a)},load:function(a,b,c){a&&!a.length&&(a=[a]);"undefined"===typeof c&&(c=b,b=
[]);var d=[];a.forEach(function(a,c){this.getAssetByResourceId(a.resourceId)||this.addAsset(a);switch(a.type){case pc.asset.ASSET_MODEL:d.push(this._createModelRequest(a));break;case pc.asset.ASSET_TEXTURE:d.push(this._createTextureRequest(a,b[c]));break;default:d.push(this._createAssetRequest(a))}},this);return this.loader.request(d.filter(function(a){return null!==a}),c).then(function(b){return new pc.promise.Promise(function(c){var k=0;d.forEach(function(c,d){a[d].resource=c?b[k++]:null});c(b)})},
function(a){setTimeout(function(){throw a;},0)})},loadFromUrl:function(a,b){if(!b)throw Error("type required");if("model"===b)return this._loadModel(a);pc.path.getDirectory(a);var c=pc.path.getBasename(a).replace(".json",""),d=new pc.asset.Asset(c,b,{url:a});return new pc.promise.Promise(function(a){this.load(d).then(function(b){a({resource:b,asset:d})})}.bind(this))},_loadModel:function(a){var b=this,c=pc.path.getDirectory(a),d=pc.path.getBasename(a),f=d.replace(".json",""),d=pc.path.join(c,d.replace(".json",
".mapping.json")),g=new pc.asset.Asset(f,"model",{url:a}),k=new pc.asset.Asset(f+".mapping","json",{url:d});return new pc.promise.Promise(function(a){b.load([g,k]).then(function(d){var e=d[0],d=d[1];g.data=d;var f=[];d.mapping.forEach(function(a){f.push(new pc.asset.Asset(pc.path.getBasename(a.path),"material",{url:pc.path.join(c,a.path)}))});d=b.load(f);d.then(function(b){for(var c=0,d=e.meshInstances.length;c<d;c++)e.meshInstances[c].material=b[c];a({resource:e,asset:g})});return d})})},_createAssetRequest:function(a){var b=
a.getFileUrl();return b?this.loader.createFileRequest(b,a.type):null},_createModelRequest:function(a){var b=a.getFileUrl();return new pc.resources.ModelRequest(b,a.data&&a.data.mapping?a.data.mapping:[])},_createTextureRequest:function(a,b){return new pc.resources.TextureRequest(a.getFileUrl(),null,b)}};return{AssetRegistry:d}}());!function(d){var a,b,c={},e={};a=function(a,b,d){c[a]={deps:b,callback:d}};b=function(a){function d(b){if("."!==b.charAt(0))return b;for(var b=b.split("/"),c=a.split("/").slice(0,-1),e=0,g=b.length;g>e;e++){var k=b[e];".."===k?c.pop():"."!==k&&c.push(k)}return c.join("/")}if(e[a])return e[a];if(e[a]={},!c[a])throw Error("Could not find module "+a);for(var k,l=c[a],n=l.deps,l=l.callback,r=[],m=0,s=n.length;s>m;m++)r.push("exports"===n[m]?k={}:b(d(n[m])));n=l.apply(this,r);return e[a]=k||n};b.entries=
c;!0;a("rsvp/all-settled",["./promise","./utils","exports"],function(a,b,c){var d=a["default"],e=b.isArray,r=b.isNonThenable;c["default"]=function(a,b){return new d(function(b){function c(a){return function(b){g(a,{state:"fulfilled",value:b})}}function f(a){return function(b){g(a,{state:"rejected",reason:b})}}function g(a,c){A[a]=c;0===--s&&b(A)}if(!e(a))throw new TypeError("You must pass an array to allSettled.");var k,s=a.length;if(0===s)return void b([]);for(var A=Array(s),z=0;z<a.length;z++)k=
a[z],r(k)?g(z,{state:"fulfilled",value:k}):d.resolve(k).then(c(z),f(z))},b)}});a("rsvp/all",["./promise","exports"],function(a,b){var c=a["default"];b["default"]=function(a,b){return c.all(a,b)}});a("rsvp/asap",["exports"],function(a){function b(){for(var a=0;a<d.length;a++){var c=d[a];(0,c[0])(c[1])}d.length=0}a["default"]=function(a,b){1===d.push([a,b])&&c()};var c,a="undefined"!=typeof window?window:{},a=a.MutationObserver||a.WebKitMutationObserver,d=[];if("undefined"!=typeof process&&"[object process]"===
{}.toString.call(process))a=function(){process.nextTick(b)};else if(a)var e=0,a=new a(b),r=document.createTextNode(""),a=(a.observe(r,{characterData:!0}),function(){r.data=e=++e%2});else a=function(){setTimeout(b,1)};c=a});a("rsvp/config",["./events","exports"],function(a,b){var c={instrument:!1};a["default"].mixin(c);b.config=c;b.configure=function(a,b){return"onerror"===a?void c.on("error",b):2!==arguments.length?c[a]:void(c[a]=b)}});a("rsvp/defer",["./promise","exports"],function(a,b){var c=a["default"];
b["default"]=function(a){var b={};return b.promise=new c(function(a,c){b.resolve=a;b.reject=c},a),b}});a("rsvp/events",["exports"],function(a){function b(a,c){for(var d=0,e=a.length;e>d;d++)if(a[d]===c)return d;return-1}function c(a){var b=a._promiseCallbacks;return b||(b=a._promiseCallbacks={}),b}a["default"]={mixin:function(a){return a.on=this.on,a.off=this.off,a.trigger=this.trigger,a._promiseCallbacks=void 0,a},on:function(a,d){var e,f=c(this);(e=f[a])||(e=f[a]=[]);-1===b(e,d)&&e.push(d)},off:function(a,
d){var e,f,s=c(this);return d?(e=s[a],f=b(e,d),void(-1!==f&&e.splice(f,1))):void(s[a]=[])},trigger:function(a,b){var d;if(d=c(this)[a])for(var e=0;e<d.length;e++)(0,d[e])(b)}}});a("rsvp/filter",["./promise","./utils","exports"],function(a,b,c){var d=a["default"],e=b.isFunction;c["default"]=function(a,b,c){return d.all(a,c).then(function(a){if(!e(b))throw new TypeError("You must pass a function as filter's second argument.");for(var f=a.length,g=Array(f),k=0;f>k;k++)g[k]=b(a[k]);return d.all(g,c).then(function(b){for(var c=
Array(f),d=0,e=0;f>e;e++)!0===b[e]&&(c[d]=a[e],d++);return c.length=d,c})})}});a("rsvp/hash-settled",["./promise","./utils","exports"],function(a,b,c){var d=a["default"],e=b.isNonThenable,r=b.keysOf;c["default"]=function(a){return new d(function(b){function c(a){return function(b){g(a,{state:"fulfilled",value:b})}}function f(a){return function(b){g(a,{state:"rejected",reason:b})}}function g(a,c){w[a]=c;0===--z&&b(w)}var k,u,w={},A=r(a),z=A.length;if(0===z)return void b(w);for(var C=0;C<A.length;C++)u=
A[C],k=a[u],e(k)?g(u,{state:"fulfilled",value:k}):d.resolve(k).then(c(u),f(u))})}});a("rsvp/hash",["./promise","./utils","exports"],function(a,b,c){var d=a["default"],e=b.isNonThenable,r=b.keysOf;c["default"]=function(a){return new d(function(b,c){function f(a){return function(c){w[a]=c;0===--z&&b(w)}}function g(a){z=0;c(a)}var k,u,w={},A=r(a),z=A.length;if(0===z)return void b(w);for(var C=0;C<A.length;C++)u=A[C],k=a[u],e(k)?(w[u]=k,0===--z&&b(w)):d.resolve(k).then(f(u),g)})}});a("rsvp/instrument",
...
for(var f=a.length,g=Array(f),k=0;f>k;k++)g[k]=b(a[k]);return d.all(g,c)})}});a("rsvp/node",["./promise","./utils","exports"],function(a,b,c){var d=a["default"],e=b.isArray;c["default"]=function(a,b){function c(){for(var e=arguments.length,k=Array(e),n=0;e>n;n++)k[n]=arguments[n];var s;return f||g||!b?s=this:(console.warn('Deprecation: RSVP.denodeify() doesn\'t allow setting the "this" binding anymore. Use yourFunction.bind(yourThis) instead.'),s=b),d.all(k).then(function(c){return new d(function(d,
e){c.push(function(){for(var a=arguments.length,c=Array(a),k=0;a>k;k++)c[k]=arguments[k];a=c[0];k=c[1];if(a)e(a);else if(f)d(c.slice(1));else if(g){for(var a={},l=c.slice(1),k=0;k<b.length;k++)c=b[k],a[c]=l[k];d(a)}else d(k)});a.apply(s,c)})})}var f=!0===b,g=e(b);return c.__proto__=a,c}});a("rsvp/promise","./config ./events ./instrument ./utils ./promise/cast ./promise/all ./promise/race ./promise/resolve ./promise/reject exports".split(" "),function(a,b,c,d,e,r,m,s,h,v){function F(){}function y(a,
b){if(!H(a))throw new TypeError("You must pass a resolver function as the first argument to the promise constructor");if(!(this instanceof y))throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");this._id=I++;this._label=b;this._subscribers=[];B.instrument&&E("created",this);if(F!==a){var c=this,d=function(a){z(c,a)},e=function(a){D(c,a)};try{a(d,e)}catch(f){e(f)}}}function u(a,b){var c,d,e=a._subscribers,f=a._detail;
B.instrument&&E(b===N?"fulfilled":"rejected",a);for(var g=0;g<e.length;g+=3)c=e[g],d=e[g+b],w(b,c,d,f);a._subscribers=null}function w(a,b,c,d){var e,f,g,h,k=H(c);if(k)try{e=c(d),g=!0}catch(l){h=!0,f=l}else e=d,g=!0;A(b,e)||(k&&g?z(b,e):h?D(b,f):a===N?z(b,e):a===P&&D(b,e))}function A(a,b){var c,d=null;try{if(a===b)throw new TypeError("A promises callback cannot return that same promise.");if(K(b)&&(d=b.then,H(d)))return d.call(b,function(d){return c?!0:(c=!0,void(b!==d?z(a,d):C(a,d)))},function(b){return c?
!0:(c=!0,void D(a,b))},"Settle: "+(a._label||" unknown promise")),!0}catch(e){return c?!0:(D(a,e),!0)}return!1}function z(a,b){a===b?C(a,b):A(a,b)||C(a,b)}function C(a,b){a._state===J&&(a._state=L,a._detail=b,B.async(G,a))}function D(a,b){a._state===J&&(a._state=L,a._detail=b,B.async(x,a))}function G(a){u(a,a._state=N)}function x(a){a._onerror&&a._onerror(a._detail);u(a,a._state=P)}var B=a.config,E=(b["default"],c["default"]),K=d.objectOrFunction,H=d.isFunction,a=d.now,e=e["default"],r=r["default"],
m=m["default"],s=s["default"],h=h["default"],a="rsvp_"+a()+"-",I=0;v["default"]=y;y.cast=e;y.all=r;y.race=m;y.resolve=s;y.reject=h;var J=void 0,L=0,N=1,P=2;y.prototype={constructor:y,_id:void 0,_guidKey:a,_label:void 0,_state:void 0,_detail:void 0,_subscribers:void 0,_onerror:function(a){B.trigger("error",a)},then:function(a,b,c){var d=this;this._onerror=null;var e=new this.constructor(F,c);if(this._state){var f=arguments;B.async(function(){w(d._state,e,f[d._state-1],d._detail)})}else{var g=this._subscribers,
h=g.length;g[h]=e;g[h+N]=a;g[h+P]=b}return B.instrument&&E("chained",d,e),e},"catch":function(a,b){return this.then(null,a,b)},"finally":function(a,b){var c=this.constructor;return this.then(function(b){return c.resolve(a()).then(function(){return b})},function(b){return c.resolve(a()).then(function(){throw b;})},b)}}});a("rsvp/promise/all",["../utils","exports"],function(a,b){var c=a.isArray,d=a.isNonThenable;b["default"]=function(a,b){var e=this;return new e(function(b,f){function g(a){return function(c){w[a]=
c;0===--u&&b(w)}}function r(a){u=0;f(a)}if(!c(a))throw new TypeError("You must pass an array to all.");var y,u=a.length,w=Array(u);if(0===u)return void b(w);for(var A=0;A<a.length;A++)y=a[A],d(y)?(w[A]=y,0===--u&&b(w)):e.resolve(y).then(g(A),r)},b)}});a("rsvp/promise/cast",["exports"],function(a){a["default"]=function(a,b){return a&&"object"==typeof a&&a.constructor===this?a:new this(function(b){b(a)},b)}});a("rsvp/promise/race",["../utils","exports"],function(a,b){var c=a.isArray,d=(a.isFunction,
a.isNonThenable);b["default"]=function(a,b){var e,f=this;return new f(function(b,g){function r(a){u&&(u=!1,b(a))}function y(a){u&&(u=!1,g(a))}if(!c(a))throw new TypeError("You must pass an array to race.");for(var u=!0,w=0;w<a.length;w++){if(e=a[w],d(e))return u=!1,void b(e);f.resolve(e).then(r,y)}},b)}});a("rsvp/promise/reject",["exports"],function(a){a["default"]=function(a,b){return new this(function(b,c){c(a)},b)}});a("rsvp/promise/resolve",["exports"],function(a){a["default"]=function(a,b){return a&&
...
function(a,b,c,d,e,r,m,s,h,v,F,y,u,w,A,z,C){function D(){G.on.apply(G,arguments)}var a=a["default"],b=b["default"],c=c["default"],d=d["default"],e=e["default"],r=r["default"],m=m["default"],s=s["default"],h=h["default"],v=v["default"],G=F.config,F=F.configure,y=y["default"],u=u["default"],w=w["default"],A=A["default"];if(G.async=z["default"],"undefined"!=typeof window&&"object"==typeof window.__PROMISE_INSTRUMENTATION__){z=window.__PROMISE_INSTRUMENTATION__;F("instrument",!0);for(var x in z)z.hasOwnProperty(x)&&
D(x,z[x])}C.Promise=a;C.EventTarget=b;C.all=d;C.allSettled=e;C.race=r;C.hash=m;C.hashSettled=s;C.rethrow=h;C.defer=v;C.denodeify=c;C.configure=F;C.on=D;C.off=function(){G.off.apply(G,arguments)};C.resolve=u;C.reject=w;C.async=function(a,b){G.async(a,b)};C.map=y;C.filter=A});d.RSVP=b("rsvp")}(window);pc.promise={Promise:window.RSVP.Promise,all:window.RSVP.all};
